...
- **已有**: 亚洲（中国 79 + 日本 26 + 韩国 28 + 蒙古 26 + 泰国 25 + 越南 25 + 马来西亚 26 +
  ...
  波兰 25 + 克罗地亚 26 + 捷克 26 + 匈牙利 14（进行中）= 563）+ 北美洲（美国 26 + 加拿大 25 = 51）+
  南美洲（智利 28 = 28）+ 大洋洲（澳大利亚 34 + 新西兰 30 = 64），
  中英双语，共 1055 个（39 个国家）
...
- **Phase B 逐国加地形，每国 ≥25 个 T1/T2/T3**：
  - ✅ 美国 26 · ✅ 加拿大 25（`north-america` 共 51）· ✅ 日本 26（`asia` 84→110）
    ...
    · 🚧 匈牙利（`europe` 549→，东欧次区域第三国，**进行中**：第 1–2 批 14 条已合并）
  ...
  - **捷克**：`country: "czechia"`（东欧次区域第二国，波兰之后）；`COUNTRIES` 按拼音插入波兰
    ...
    深切曲流→`valley`。
  - **匈牙利**：`country: "hungary"`（东欧次区域第三国，波兰、捷克之后）；`COUNTRIES` 按拼音
