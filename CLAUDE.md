...
- **已有**: 亚洲（中国 79 + 日本 26 + 韩国 28 + 蒙古 26 + 泰国 25 + 越南 25 + 马来西亚 26 +
  新加坡 12 + 菲律宾 22 + 印度尼西亚 26 + 哈萨克斯坦 26 + 乌兹别克斯坦 25 + 土耳其 28 = 374）+ 欧洲（英国 33 +
...
**地图/交互/双语已完成**：地形注册表（见 §范围，当前 1294 个）+ 数据驱动相机 +
...
- **`TERRAIN_REGISTRY`（当前 1294 个，见 §范围）= 单一真实源**：纯地貌图鉴，不含人文聚落
...
**前提**：本项目 1294 处地形 × 6 板块 + 784 座城市 × 7 段 + 285 条航线 × 2 套解说
