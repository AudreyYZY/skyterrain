...
**现状（2026-09-07，全库核完一遍）**：280 条 = 91 条属实 + 163 条有误已改正 +
26 条有误且找不到可靠替代（`status: "wrong"`，界面/搜索/解说都不显示航班号）。
**189 条至少有一处错，占 68%**；冰岛 / 挪威 / 法国 / 意大利 / 西班牙 / 葡萄牙 / 丹麦 /
蒙古八国的国内线错误率是 100%。另有 15 条现实中没有不经停航班的航线已整条移除
（295 → 280；不用「不显示航班号」把一条飞不了的线留在库里）。
