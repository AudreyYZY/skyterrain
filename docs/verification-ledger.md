...
## 覆盖现状（截至 2026-09-21；各行具体时点见说明）

| 内容 | 总数 | 已核实 | 说明 |
|---|---|---|---|
| 航线航班信息 | 297 | **297 条均有来源状态** | 283 条可展示核实后的航班信息；5 条 `wrong` + 9 条 `flight-unknown` 不显示航班号或机型。2026-09-07 首轮 280 条审计为 91 属实 / 163 改正 / 26 无替代；后来新增航线逐条留 `source` |
| 航线解说 | 297 × 2 套（学习 / 旅游）× 2 语言 | **297 条均有 `sources` 留痕** | 距离、承运人、机型、汉字数字由 `check:distance` / `check:routes` / `check:zhen` 离线守住；`flight-unknown` 解说不得点名航班号、机型或时长 |
