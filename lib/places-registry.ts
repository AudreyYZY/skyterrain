...
export const ZONE_META: Record<string, { zh: string; en: string; order: number }> = {
  ...
  "sk-bratislava": { zh: "布拉迪斯拉发地区", en: "Bratislava Region", order: 420 },
  "sk-west": { zh: "西斯洛伐克", en: "Western Slovakia", order: 421 },
  "sk-tatras": { zh: "塔特拉山区", en: "Tatra Region", order: 422 },
  "sk-central": { zh: "中斯洛伐克", en: "Central Slovakia", order: 423 },
  "sk-north": { zh: "北斯洛伐克", en: "Northern Slovakia", order: 424 },
  "sk-east": { zh: "东斯洛伐克", en: "Eastern Slovakia", order: 425 },
  "hu-budapest": { zh: "布达佩斯", en: "Budapest", order: 430 },
  "hu-transdanubia": { zh: "外多瑙", en: "Transdanubia", order: 431 },
  "hu-north": { zh: "北部山地", en: "Northern Hungary", order: 432 },
  "hu-great-plain": { zh: "大平原", en: "Great Plain", order: 433 },
  "si-central": { zh: "中部（卢布尔雅那一带）", en: "Central Slovenia", order: 440 },
  "si-alps": { zh: "朱利安阿尔卑斯", en: "Julian Alps", order: 441 },
  "si-west": { zh: "西部", en: "Western Slovenia", order: 442 },
  "si-coast": { zh: "海岸", en: "Slovenian Coast", order: 443 },
  "si-east": { zh: "东部", en: "Eastern Slovenia", order: 444 },
  "mt-harbour": { zh: "港口一带", en: "Harbour area", order: 450 },
  "mt-north": { zh: "北部", en: "Northern Malta", order: 451 },
  "mt-west": { zh: "西部", en: "Western Malta", order: 452 },
  "mt-south": { zh: "南部", en: "Southern Malta", order: 453 },
  "mt-gozo": { zh: "戈佐岛", en: "Gozo", order: 454 },
  "ee-north": { zh: "北部", en: "Northern Estonia", order: 460 },
  "ee-west": { zh: "西部", en: "Western Estonia", order: 461 },
  "ee-south": { zh: "南部", en: "Southern Estonia", order: 462 },
  "ee-islands": { zh: "西部群岛", en: "West Estonian islands", order: 463 },
  "ee-northeast": { zh: "东北部", en: "North-eastern Estonia", order: 464 },
  "lv-riga": { zh: "里加地区", en: "Riga Region", order: 470 },
  "lv-vidzeme": { zh: "维泽梅", en: "Vidzeme", order: 471 },
  "lv-kurzeme": { zh: "库尔泽梅", en: "Kurzeme", order: 472 },
  "lv-zemgale": { zh: "泽姆加莱", en: "Zemgale", order: 473 },
  "lv-latgale": { zh: "拉特加莱", en: "Latgale", order: 474 },
  "lt-east": { zh: "东部（维尔纽斯一带）", en: "Eastern Lithuania", order: 480 },
  "lt-central": { zh: "中部", en: "Central Lithuania", order: 481 },
  "lt-west": { zh: "西部海岸", en: "Lithuanian coast", order: 482 },
  "lt-north": { zh: "北部", en: "Northern Lithuania", order: 483 },
  "ro-south": { zh: "南部（蒙特尼亚）", en: "Southern Romania (Muntenia)", order: 490 },
  "ro-center": { zh: "中部（特兰西瓦尼亚）", en: "Transylvania", order: 491 },
  "ro-west": { zh: "西部", en: "Western Romania", order: 492 },
  "ro-southeast": { zh: "东南（多布罗加与黑海）", en: "South-east (Dobruja and the coast)", order: 493 },
  "bg-west": { zh: "西部（索非亚一带）", en: "Western Bulgaria", order: 500 },
  "bg-north": { zh: "北部（多瑙河平原）", en: "Northern Bulgaria", order: 501 },
  "bg-south": { zh: "南部（上色雷斯与山地）", en: "Southern Bulgaria", order: 502 },
  "bg-coast": { zh: "黑海沿岸", en: "Black Sea coast", order: 503 },
  "uz-center": { zh: "中部", en: "Central Uzbekistan", order: 510 },
  "uz-east": { zh: "东部（费尔干纳一带）", en: "Eastern Uzbekistan", order: 511 },
  "uz-west": { zh: "西部", en: "Western Uzbekistan", order: 512 },
  ...
  "za-mpumalanga": { zh: "姆普马兰加省", en: "Mpumalanga", order: 567 },
  "za-north-west": { zh: "西北省", en: "North West", order: 568 },
};
