...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "chiang-rai": {
    ...
    //   补上了前两轮因一手站点直连失败留下的缺口。
    identity:
      "清莱是泰国最北端的府份首府，2025年市自治市登记人口约7.4万，以白庙、蓝庙等当代宗教艺术建筑闻名。",
    ...
    howItWorks:
      "清莱是清莱府的府治，府尹由内政部任命；清莱市是一个“城市自治市”，有民选的市长，2025 年登记人口约 7.4 万，而全府 2024 年登记约 130 万人。市区在滚河边，1262 年孟莱王在此建立兰纳王国的第一座都城，钟楼与夜市是市中心的坐标，机场在城北，没有铁路；白庙在南面 13 公里，蓝庙在城北，黑屋在城外，美斯乐茶园在西北的山区。初来的人最容易犯的错，是以为白庙和山区茶园都在清莱城里，而它们各在几十公里外，市区本身是一座安静的府城。",
    layout:
      "清莱镇规模较小，白龙寺（白庙）位于城郊，蓝庙与黑屋博物馆分布在市区不同方向，府境北部与西北部是山区。",
    gettingAround:
      "清莱国际机场距市区直线约6.4公里；去城外的寺庙和山区茶园建议自驾或包车。",
    culture:
      "清莱府是泰国北部多个少数民族聚居的地区之一，山地部落传统手工艺与农产品在当地市集常见。",
    seeAndDo:
      "白龙寺（当代佛教艺术建筑）；蓝庙；黑屋博物馆；美斯乐山地茶园。",
    whenAndTips:
      "11月至次年2月凉季最宜人，山区清晨气温较低。府境北部靠近国界，行程留在府城与主要景点一带，不要前往边境口岸与对岸地区。",
  },
  "koh-samui": {
