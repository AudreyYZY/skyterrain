...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  lodz: {
    // 全七段 sources（2026-09-16 首写，已有城市补充批；研究子代理事实表 scratchpad/be-pl-cities-facts.md §0、§5–6）：
    //   人口：2025 年末 639,890（GUS《Powierzchnia i ludność w przekroju terytorialnym w 2026 r.》Tabl. 20，2026-04-29 发布，1 级；同表托伦 192,784 与既有条目自检一致）；按同表城市人口排序第 4（算）。
    //   市长直选、与市议会同届、2018 年起任期 5 年（Sejm ISAP 法律目录，1 级）；1993 年撤销五区行政职能（pl.wikipedia，3 级）、2000 年起 36 个居民区辅助单位（BIP UML，1 级摘要）。
    //   1821 年工业定居点、1821–1823 年沿皮奥特尔科夫斯卡街测设新城、八角形新市场即自由广场（uml.lodz.pl，1 级摘要）。
    //   国家历史古迹「罗兹——工业城市的多元文化景观」总统令 2015-02-16（WUOZ 罗兹，1 级）；UNESCO 创意城市网络「电影之都」2017（citiesoffilm.org / culture.pl，2 级）。
    //   曼努法克图拉：原波兹南斯基棉纺厂，2006-05-17 开放（manufaktura.com，1 级）；神父磨坊 1971 年列为古迹（lodz.travel，1 级）；EC1 发电厂改造、2018 年开放科学技术中心（lodz.travel，1 级）；皮奥特尔科夫斯卡街长约 4.2 km（UML，2 级）。
    //   交通：LCJ 直线约 7 km（算），有定期航班（2–3 级）；华沙—罗兹工厂站约 1 小时 05 分至 1 小时 34 分（3 级，正文写「约 1 小时到 1 个半小时」）。
    //   本国惯例：UOKiK 餐厅收服务费须在点餐前告知（1 级）；「凑整或给一成左右」只有 3 级，与既有 12 个波兰条目方向一致。
    //   不写：犹太隔离区与二战、「四种文化之城」族群叙事、工厂主族裔、纺织业崩溃的政治评价、「波兰最长步行街」「最现代天文馆」等比较句。 核实 2026-09-16 当批（content-verifier 独立检索，本条全部 ok）。
    identity:
      "罗兹是波兰中部罗兹省的省会，2025年末人口约64万（GUS），按同一统计表的城市人口排在波兰第四。它是19世纪按规划建起来的纺织工业城，“罗兹——工业城市的多元文化景观”2015年被定为国家历史古迹，2017年罗兹以“电影之都”加入联合国教科文组织创意城市网络。",
    howItWorks:
      "罗兹的市长由居民直接选举，与市议会同届、任期5年；罗兹是有县地位的市，也是罗兹省省会。城里原有的五个区从1993年起不再是行政单位，名字仍在日常使用，2000年起全市划为36个居民区，各有居民区议会，作为辅助单位。城市的骨架是一条南北向的大街：1821年罗兹被定为工业定居点，随后沿皮奥特尔科夫斯卡街测设新城，八角形的新市场就是今天的自由广场；此后工厂主把工厂、工人住宅和自己的宫邸建在一处，波兹南斯基、沙伊布勒等人的厂区至今是城市地标。20世纪末纺织业衰落后，厂房陆续改作商场、博物馆和文化中心——波兹南斯基棉纺厂2006年变成了曼努法克图拉，第一座城市发电厂改成了EC1文化城。初来的人最容易犯的错，是去找一个中世纪老城广场，罗兹没有；这里的主街是一条约4.2公里长的大街，地标是工厂。",
    layout:
      "自由广场在皮奥特尔科夫斯卡街北端，大街从这里一路向南；波兹南斯基宫在广场西北不远，曼努法克图拉在广场以西不到1公里。罗兹工厂站与EC1文化城在广场东南，直线约1.3至1.4公里；神父磨坊在更远的东南方向，离广场直线约3公里。",
    gettingAround:
      "罗兹瓦迪斯瓦夫·莱蒙特机场离市中心直线约7公里，有定期航班；更多国际航班可经华沙。火车从华沙到罗兹工厂站约1小时到1个半小时。市内以有轨电车和公交为主，皮奥特尔科夫斯卡街适合步行。属温带大陆性气候，冬季寒冷。",
    culture:
      "官方语言为波兰语。罗兹与电影关系深，皮奥特尔科夫斯卡街的路面上有电影星光大道。餐厅账单通常不含服务费，习惯上凑整或给一成左右小费；如果收服务费，餐厅须在点餐前告知。",
    seeAndDo:
      "皮奥特尔科夫斯卡街与OFF Piotrkowska院落；曼努法克图拉（含工厂博物馆与ms²现代艺术馆）；波兹南斯基宫（罗兹城市博物馆）；神父磨坊工业住宅区；EC1罗兹文化城的科学技术中心与天文馆。",
    whenAndTips:
      "5–9月适合在皮奥特尔科夫斯卡街坐露天座位；冬季寒冷。工业遗产分散在城里各处，神父磨坊离自由广场直线约3公里，安排时留出交通时间。",
  },

  lublin: {
    // 全七段 sources（2026-09-16 首写，已有城市补充批；研究子代理事实表 scratchpad/be-pl-cities-facts.md §0、§5、§7）：
    //   人口：2025 年末 326,685（GUS 年刊 Tabl. 20，1 级，同 lodz）。
    //   市长直选、任期 5 年（1 级）；市议会 31 席、第九届 2024–2029（BIP / lublin.eu，1 级）；27 个区是居民发起设立的辅助单位、各有区议会（lublin.eu，1 级摘要）。
    //   1317 年马格德堡法城市特许状、1569 年卢布林联合在城堡签署、1578 年王室法庭驻此（NID zabytek.pl，1 级）；国家历史古迹总统令 2007-04-25（zabytek.pl，1 级）。
    //   城堡 1823–1826 年改建为新哥特式；三一礼拜堂拜占庭—罗塞尼亚风格壁画 1418 年完成（NID，1 级；日期 2 级）；主教座堂 1592–1604 年建（NID，1 级）；成为主教座堂的年份研究稿记 1818、当批核实查到 1805 年卢布林教区设立时即为主教座堂（pl.wikipedia，3 级），两说未定，正文不写年份；克拉科夫门 14 世纪（NID，1 级）。
    //   16 世纪起城市沿克拉科夫郊区大街越出城墙发展（NID，1 级）。
    //   交通：LUZ 直线约 10 km（算），有定期航班（2 级）；PKP Intercity 2025/2026 年度时刻表华沙—卢布林每天 16 对（intercity.pl，1 级）；车程约 1 小时 50 分到 2 小时出头（2 级）；总站在老城广场以南直线约 1.8 km（算）。
    //   本国惯例：同 lodz。
    //   不写：马伊达内克、二战与大屠杀、老城犹太区、1944 年「卢布林政府」、城堡的监狱用途、东部国界（离乌克兰约 74 km、白俄罗斯约 77 km）、天主教大学的宗教定位、「波兰最美城堡」比较句。 核实 2026-09-16 当批（content-verifier 独立检索，正文全部 ok；注释里主教座堂年份改为两说）。
    identity:
      "卢布林是波兰东部卢布林省的省会，2025年末人口约32.7万（GUS）。1317年获城市特许状，1569年波兰与立陶宛在这里的城堡签署了卢布林联合；卢布林的历史建筑与城市规划群2007年被定为国家历史古迹。",
    howItWorks:
      "卢布林的市长由居民直接选举，与31席的市议会同届、任期5年；全市27个区是辅助单位，都是居民陆续发起设立的，各有区议会，并不是独立的政府。老城和城堡分别在相邻的两座小山上：老城广场中央是旧王室法庭，1578年起这里是王国贵族的最高上诉法院所在地；城堡在老城东北的山头，现在的外观是1823至1826年改建的新哥特式，里面的三一礼拜堂保存着1418年完成的拜占庭—罗塞尼亚风格壁画。16世纪起城市越过城墙，沿克拉科夫门以西的克拉科夫郊区大街发展，这条街至今是商业主街。初来的人最容易犯的错，是把老城当成整个市中心，其实主街在克拉科夫门外，火车站在老城以南近两公里；也常以为27个区各有独立的政府。",
    layout:
      "老城广场与旧王室法庭是老城中心；克拉科夫门在广场西边，门外就是克拉科夫郊区大街；主教座堂在广场南边不远；城堡在广场东北不到400米的另一座小山上。卢布林总站在老城以南直线约1.8公里，乡村露天博物馆在城西，离老城直线约4.5公里。",
    gettingAround:
      "卢布林机场离老城直线约10公里，有定期航班。火车往返华沙，PKP城际2025/2026年度时刻表里每天有16对，车程约两小时（截至2026年）。老城与城堡步行可达，去火车站和露天博物馆可乘公交。属温带大陆性气候，冬季寒冷。",
    culture:
      "官方语言为波兰语。卢布林有多所大学。餐厅账单通常不含服务费，习惯上凑整或给一成左右小费；如果收服务费，餐厅须在点餐前告知。",
    seeAndDo:
      "老城广场与克拉科夫门；卢布林城堡与三一礼拜堂壁画（属卢布林国家博物馆）；主教座堂；老城地下酒窖通道；卢布林乡村露天博物馆。",
    whenAndTips:
      "5–9月气候宜人，冬季寒冷。老城与城堡在两座小山上，中间有坡道和台阶，穿舒适的鞋。",
  },
};
