...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  albany: {
    ...
    identity:
      "Albany lies on Western Australia's south coast about 420 km by road south-east of Perth, with a population of about 42,300 in the local government area (June 2025, Australian Bureau of Statistics). A British post was established here on 26 December 1826, more than two years before Perth and Fremantle, making it the state's oldest colonial settlement. King George Sound is a natural deep-water harbour from which the first convoy of Anzac troops sailed in 1914 — the theme of the National Anzac Centre opened in 2014. The Gap and the Natural Bridge in Torndirrup National Park to the south are landmarks of the granite coast, and the whaling station that closed in 1978 was Australia's last. The traditional owners are the Menang people of the Noongar nation.",
  ...
  busselton: {
    ...
    gettingAround:
      "Busselton Margaret River Airport (BQB), about 6.5 km in a straight line from the centre, has a Melbourne service three times a week; the Sydney service has been suspended since 2 June 2026 over fuel costs, with the airline giving 21 September 2026 as the resumption date; from Perth Airport it is about 2.5–3 hours by car, and coaches run. Walk or cycle in town; Margaret River, the caves and the wineries need a car. The climate is Mediterranean — warm dry summers, mild wet winters, and frequent sea breezes.",
    culture:
  ...
  devonport: {
    ...
    howItWorks:
      "Devonport is a port city on Tasmania's north coast, governed by the City of Devonport with about 27,000 people in June 2025, the island's third city; the council runs local services and the rest belongs to the state. The city lies on both banks of the Mersey mouth, the Spirit of Tasmania sails from here to Geelong, the port handles more than half the island's freight, the airport lies east of town and Launceston about 100 km south-east; Cradle Mountain lies about 65 km in a straight line south-west in another council area. Newcomers most often go wrong by taking Devonport for the gate of Cradle Mountain, when it is a ferry and freight port and the mountain is another hour's drive.",
    layout:
      "The city straddles the Mersey: the centre and the ferry terminal are on the west bank, East Devonport and the airport side on the east. North of the centre is Mersey Bluff, with the lighthouse, Tiagarra and a coastal walk, and beaches below. West along the coast is Burnie (about 47 km); east are Latrobe and Sheffield (the mural town), and Launceston about 100 km south-east; the Cradle Mountain–Lake St Clair National Park is about 65 km in a straight line south-west in the mountains. The airport is about 10 km east.",
    gettingAround:
  ...
  rockhampton: {
    ...
    identity:
      "Rockhampton lies on the Fitzroy River in central Queensland about 45 km from the river's mouth and 630 km north of Brisbane, with a population of about 85,800 in the local government area (June 2025, Australian Bureau of Statistics). It sits just north of the Tropic of Capricorn, marked by a monument in town, and calls itself Australia's 'beef capital' for the vast cattle country around it. Quay Street by the river preserves a run of 19th-century sandstone commercial buildings, Mount Archer to the east overlooks the city, and Yeppoon and Great Keppel Island on the Capricorn Coast lie about 36 km in a straight line east. The traditional owners are the Darumbal people.",
    // howItWorks sources: ABS《Regional population, 2024–25 financial year》（2026-03-31 发布），ERP 时点 2025-06-30，子代理直接读取一手数据表 32180DS0002_2024-25.xlsx（LGA）/ 32180DS0004_2001-25.xlsx（SUA）/ 32180DS0003_2001-25.xlsx（SA2）得出。https://www.abs.gov.au/statistics/people/population/regional-population/latest-release （级别 1）
    //   ABS Regional population 每年 3 月下旬发布上一财年（截至 6 月 30 日）的数，下一期预计 2027-03。
  ...
  albury: {
    ...
    layout:
      "The city centre climbs a gentle slope on the north bank of the Murray; Dean Street is the main street and Noreuil Park and the river walk line the water; across the Hume Highway bridge is Wodonga in Victoria. The Hume Dam is about 10 km in a straight line east, with Bonegilla on the Wodonga side of the lake. The Rutherglen wineries are about 45 km south-west and the gold-rush town of Beechworth about 40 km south. The airport is about 4 km east of the centre.",
    gettingAround:
  ...
  cessnock: {
    ...
    layout:
      "The town sits on the flat southern edge of the valley, its main street lined with old mining-town buildings. The wineries cluster about 9 km in a straight line north and north-west around Pokolbin, Lovedale, Rothbury and Mount View, with the Hunter Valley Gardens (a large display garden) at Pokolbin; Broke and Wollombi lie in the valleys further west. The Brokenback Range rises to the north, with Singleton in the upper valley beyond. Newcastle Airport is about 53 km east.",
    gettingAround:
  ...
  warrnambool: {
    ...
    layout:
      "The centre sits on a terrace above the sea, with Liebig Street the main street and Flagstaff Hill overlooking the harbour on the south side; the Logans Beach whale platform is about 5 km east beyond the Hopkins River mouth. The Tower Hill crater is about 15 km west, and the harbour town of Port Fairy about 15 km further; eastwards the Great Ocean Road reaches the Twelve Apostles and Port Campbell in about 80 km. Hopkins Falls lie north-east of town. The airport, about 11 km north-west, serves general aviation only.",
    gettingAround:
  ...
  tanunda: {
    identity:
      "Tanunda is the central town of South Australia's Barossa Valley, about 70 km by road north-east of Adelaide, with about 4,700 people (2021 census). The Barossa is one of Australia's most famous wine regions: Prussian settlers founded villages such as Bethany and Langmeil in the 1840s, and Lutheran churches, baking and smallgoods traditions survive; the shiraz vines planted in 1847 at Turkey Flat in Tanunda are regarded as among the oldest still in commercial production anywhere, and Seppeltsfield, Penfolds and Jacob's Creek are among the great names in the valley. The Tanunda Town Band is one of the oldest brass bands in the southern hemisphere. The Traditional Owners are the Peramangk and Ngadjuri peoples.",
