...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  dubbo: {
    ...
    gettingAround:
      "达博地区机场（DBO）距市区约4公里。火车（悉尼—达博XPT）约6.5小时；开车从悉尼约5小时。市内有公交，市中心步行；动物园内骑车、开车或坐观光车。属亚热带湿润与半干旱交界的气候，夏季炎热、冬季凉爽干燥。",
    culture:
  ...
  "hervey-bay": {
    ...
    gettingAround:
      "赫维湾机场（HVB）在乌兰甘，距市区约9公里，有定期航班。火车到玛丽伯勒西站再转大巴；开车从布里斯班约3.5小时。市内有公交，海滨适合骑行；去河头码头要开车，上卡丽需四驱车（可租或跟团）。属亚热带湿润气候，夏季炎热潮湿，冬季温暖干燥、是观鲸旺季。",
    culture:
