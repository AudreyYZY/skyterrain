...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  barcelona: {
    ...
    //   同上。
    howItWorks:
      "Barcelona is the capital of Catalonia, governed by a mayor and council, with ten districts, each with a district council; the municipality covers about 101 km² with about 1.71 million people as of 1 January 2025, while the Àrea Metropolitana de Barcelona created in 2011 gathers 36 municipalities and about 3.3 million people, with L'Hospitalet and Badalona pressed against the city line as cities of their own. The city is framed on four sides by the Collserola hills, the Mediterranean, the Llobregat and the Besòs: the Ciutat Vella is a medieval maze, the Eixample planned by Cerdà in 1859 is a grid of chamfered blocks, and Gràcia, Sants and Sarrià were independent towns absorbed later, still keeping village centres of their own. Catalan and Spanish are co-official, with Catalan first on signs and in official use. Addresses give street, number and postcode. The TMB metro and Rodalies suburban trains cover the metropolitan area, and the Rondas ring roads are its expressways. Newcomers most often go wrong by taking the municipality for the whole city, when it is the core of a metropolitan area of 3.3 million.",
    layout:
  ...
  girona: {
    ...
    gettingAround:
      "Girona–Costa Brava Airport (GRO), about 12 km from the city, is dominated by Ryanair and other low-cost airlines, with a bus of about 25 minutes to the city. The AVE takes about 38 minutes from Barcelona and about 5.5 hours from Paris (direct); regional trains from Barcelona take about 1.5 hours. The old town is walkable; Figueres is 15–40 minutes by train, and the Costa Brava by bus or car. The climate is Mediterranean with hot summers and cool winters.",
    culture:
