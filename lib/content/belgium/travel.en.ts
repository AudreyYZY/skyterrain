...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  brussels: {
    ...
    howItWorks:
      "The Brussels people speak of is, administratively, the Brussels-Capital Region, one of Belgium's three regions: about 162 km² with about 1.25 million people in 2026, created in 1989 with a government and parliament of its own, and assembled from nineteen municipalities, each with an elected council and a mayor nominated by the council majority and appointed by the Brussels-Capital Region Government, responsible for local policing, roads and the civil register. The nominal 'City of Brussels' is only one of them, with about 198,000 people, taking in the pentagon of the old centre, Laeken to the north and the north-eastern quarter of the EU institutions; Ixelles, Schaerbeek, Anderlecht and Uccle are municipalities in their own right, and locals write the municipality, not 'Brussels', in their address. The region is officially bilingual, French and Dutch side by side, French in practice the majority language, and it is entirely surrounded by the Dutch-speaking province of Flemish Brabant. The EU quarter around Schuman makes it at once the capital of Belgium, of Flanders and of the European Union. Addresses give street, number and postcode, with 1000 to 1210 matching the municipalities. STIB's four metro lines and trams serve the region, and the R0 ring is its boundary. The Grand-Place was inscribed as World Heritage in 1998. Newcomers most often go wrong by taking the 'City of Brussels' for the whole city, when it is one municipality among nineteen.",
    layout:
  ...
  namur: {
    ...
    howItWorks:
      "Namur is the capital of Wallonia — the Walloon Parliament and government have sat here since 1986 — and also the capital of Namur Province, governed by an elected council, with the mayor designated by law as the councillor with the most preference votes on the largest majority list, the municipality covering about 176 km² and taking in 24 absorbed communes, with about 115,000 people in 2026. The city stands on the spit where the Sambre joins the Meuse, the citadel on the rock between the two rivers now demilitarised, the old town at its foot and the eighteenth-century cathedral of Saint-Aubain as its landmark; stilt jousting has been practised here since 1411 and was added to the intangible heritage list in 2021. Railways join it to Brussels, Luxembourg, Lille and Liège, and machinery, leather and porcelain are the old industries. Newcomers most often go wrong by assuming Wallonia's capital is a larger city such as Liège or Charleroi, when the parliament and government sit in this city of 115,000.",
    layout:
  ...
  mechelen: {
    // 全七段 sources: 同中文侧（IBZ/RRN population 2026-01-01, tier 1; VRT NWS / VVSG on the Flemish mayor rule, tier 2; UNESCO component tables 943-015, 943-016, 855-003, tier 1; Visit Mechelen on carillons, tier 1; VRT NWS 2025-08-06 on Hof van Savoye, tier 2; iRail/NMBS timetables, tier 2; Code of Economic Law art. VI.4, tier 1; distances computed）。 核实 2026-09-16 当批（content-verifier 独立检索，本条全部 ok）。
    identity:
      "Mechelen is a historic city in Belgium's Antwerp Province, lying between Brussels and Antwerp, with a municipal population of about 90,300 on 1 January 2026 (Belgian National Register). It holds three components of World Heritage sites: the belfry of the old cloth hall on the Grote Markt, St Rumbold's Tower and the Great Beguinage; and Belgium's carillon culture was added to UNESCO's Register of Good Safeguarding Practices for intangible heritage in 2014.",
    howItWorks:
      "Mechelen is in the Flemish Region, governed by an elected council, with the mayor taken from the largest party of the governing majority by preference votes and appointed by the Flemish Government; the municipality is made up of Mechelen proper and five former municipalities merged in 1977, covers about 65 km², and Dutch is the language here. A ring road encircles the old town, the river Dijle runs through it, and the Grote Markt and St Rumbold's Cathedral stand at its heart. In the late 15th and early 16th centuries this was the administrative and judicial centre of the Burgundian Netherlands: in 1473 Charles the Bold placed the Great Council, the supreme court, in Mechelen, and from 1507 Margaret of Austria held her court here — her palace is still used as a courthouse today. St Rumbold's Tower is nearly 100 metres tall and can be climbed, and its two carillons have 98 bells between them; the carillon school founded here in 1922 was, according to Visit Mechelen, the first in the world. The mistake newcomers most often make is to treat Mechelen as a stop on the way between Brussels and Antwerp, when both cities and Brussels Airport are within half an hour by train, making it a good base in its own right; many also assume the city has only one World Heritage belfry, when the list counts two in Mechelen.",
    layout:
      "The Grote Markt is the centre of the old town, with the town hall on its east side and St Rumbold's Tower and Cathedral on its north side; the Hof van Busleyden museum is a few hundred metres north of the square, the Hof van Savoye lies east of it, and the Great Beguinage is in the north-west of the old town. The railway station is south of the old town, about 1 km from the Grote Markt in a straight line.",
    gettingAround:
      "The nearest airport with scheduled flights is Brussels Airport, about 14 km away in a straight line, just over 10 minutes by direct train. Mechelen station is on the main line between Brussels and Antwerp, with intercity trains taking a little over 20 minutes to Brussels-Central and about 17 minutes to Antwerp-Central (September 2026 timetable). The old town is compact enough to walk or cycle. The climate is temperate maritime, mild and damp all year.",
    culture:
      "The official language is Dutch. Carillons are Mechelen's tradition, and the carillon school founded in 1922 still trains carillonneurs today. Belgian law requires displayed prices to include any service charge that must be paid, so tipping is not necessary.",
    seeAndDo:
      "Climbing St Rumbold's Tower; the Grote Markt and town hall; the Great Beguinage; the Hof van Busleyden museum; the Hof van Savoye, whose garden and some of its rooms have been open to the public since September 2025; and the Het Anker brewery.",
    whenAndTips:
      "April–June and September–October are pleasant; Mechelen is close to both Brussels and Antwerp, so it works as a base for day trips to either. The tower climb involves a great many steps, so pace yourself.",
  },

  tournai: {
    // 全七段 sources: 同中文侧（IBZ/RRN population 2026-01-01, tier 1; tournai.be on history, the 1977 merger, the cathedral and belfry, tier 1; CDLD L1123-4, tier 1; UNESCO 1009 and 943-032, tier 1; Walloon government heritage page on the belfry, tier 1; RTBF on the Pont des Trous, tier 2; iRail/NMBS timetables, tier 2; distances computed）。 核实 2026-09-16 当批（content-verifier 独立检索，钟楼开放范围 1 处改正，火车时长 unknown 保留 iRail 时刻写法）。
    identity:
      "Tournai is a historic city in Hainaut Province in Belgium's Walloon Region, with the river Scheldt running through it and a municipal population of about 69,000 on 1 January 2026 (Belgian National Register). Tournai's Notre-Dame Cathedral was inscribed as a World Heritage site in 2000, and the city's belfry is part of the Belfries of Belgium and France World Heritage site; according to the city council, Tournai, Arlon and Tongeren are among the oldest cities in Belgium.",
    howItWorks:
      "Tournai is governed by an elected council, with the mayor designated by law as the councillor with the most preference votes on the list that won the most votes among the parties signing the majority agreement, with no separate appointment by the regional government; the 1977 municipal mergers brought 29 surrounding villages into Tournai, so today's municipality is made up of 30 former municipalities covering about 214 km², and French is the language here. The old town centres on the Grand-Place, with the belfry at one corner and the five-towered cathedral right beside it, while the Scheldt crosses the city north of the square. The city's history begins in the 1st century BC; in the 5th century it was a royal seat of the early Merovingian dynasty, and between the 12th and 16th centuries trade flourished and the cathedral, the belfry and the fortified Pont des Trous over the river were all built. The belfry, begun after the city received its charter in 1188, is 72 metres tall and, according to the Walloon government, the oldest surviving belfry in Belgium. The cathedral was damaged by a tornado in 1999, and the major restoration that began in 2006 is still under way. The mistake newcomers most often make is to think Tournai is just its old town, when most of the municipality is fields and villages; many also assume the belfry belongs to the town hall, when it is a free-standing tower that historically served as a watchtower and bell tower.",
    layout:
      "The Grand-Place is the centre of the old town, with the belfry at its south-east corner and Notre-Dame Cathedral immediately to its east; TAMAT, the tapestry museum, is south of the square, and the Museum of Fine Arts a few hundred metres further south. The Scheldt flows north of the square, with the Pont des Trous on the stretch of river in the north-west of the old town; the railway station is on the north bank, about 1 km from the Grand-Place in a straight line.",
    gettingAround:
      "Tournai has no airport with scheduled flights. Within Belgium the nearest airports with scheduled flights are Brussels South Charleroi (about 77 km in a straight line) and Brussels Airport (about 84 km in a straight line), while Lille-Lesquin Airport in France is closer, at about 21 km in a straight line. Trains take about an hour to Brussels-South, about half an hour to Mons, and also about half an hour to Lille-Flandres in France (September 2026 timetable). The old town is walkable. The climate is temperate maritime, mild and damp all year.",
    culture:
      "The official language is French. Tournai has a tradition of tapestry and textile craft, and the city has a museum dedicated to tapestry and textile arts. Belgian law requires displayed prices to include any service charge that must be paid, so tipping is not necessary.",
    seeAndDo:
      "Notre-Dame Cathedral; the belfry (reopened on 14 July 2026 with access up to its second platform, an arrangement that is still provisional); the Grand-Place; the Pont des Trous; the Museum of Fine Arts, designed by Victor Horta and, according to the city council, home to the only two paintings by Manet in Belgium; and TAMAT, the tapestry and textile arts museum.",
    whenAndTips:
      "April–June and September–October are pleasant; the cathedral is still under restoration, so parts of it may be screened off, and the belfry's opening arrangements are still provisional, so check the latest before you go.",
  },
};
