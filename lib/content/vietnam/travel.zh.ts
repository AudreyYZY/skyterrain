...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "phu-quoc-city": {
    ...
    howItWorks:
      "富国岛是越南最大的岛，约 575 平方公里，2021 年设市，2025 年 7 月县级单位撤销后改为“特区”，直属安江省——坚江省同年并入安江，省会在迪石。岛上人口约 18 万，主镇阳东在西岸，机场、夜市与长滩都在附近，安泰在南端，缆车通往海上的香岛，北面是新建的度假城，鱼露与胡椒是老产业，2012 年启用的国际机场，加上对多国游客的免签入境（具体天数与适用国家以越南主管部门最新公布为准），让它成为面向国际的度假岛。初来的人最容易犯的错，是把富国当作一座度假村，而它是一个有 18 万居民、南北 50 公里的岛，特区政府在阳东。",
    layout:
