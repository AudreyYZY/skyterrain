...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  "da-lat": {
    ...
    identity:
      "Da Lat is the seat of Lâm Đồng province, which absorbed Bình Thuận and Đắk Nông in 2025 and kept the name Lâm Đồng. On 1 July 2025 Da Lat's city-level status was abolished and its territory reorganised into five wards — Xuân Hương, Cam Ly, Lâm Viên, Xuân Trường and Lang Biang; the 2025 resolution that did so lists baseline populations for the five adding up to about 299,700, but it gives no reference date for that figure, so it cannot be read as a post-reorganisation count. The earlier figure of about 258,000 refers to the former city at the end of 2022. The town stands at about 1,500 m elevation; developed as a summer retreat during the French colonial period, it is now an important flower- and produce-growing region in Vietnam.",
