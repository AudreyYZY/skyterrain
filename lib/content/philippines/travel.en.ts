...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  "philippines-overview": {
    ...
    identity:
      "The Republic of the Philippines is a Southeast Asian archipelago of about 7,641 islands, covering roughly 299,800 km² with a population of 112.7 million in the 2024 census (Philippine Statistics Authority); its capital is Manila, the official languages are Filipino (based on Tagalog) and English, and its currency is the Philippine peso (PHP).",
    layout:
    ...
    culture:
      "The official languages are Filipino and English, with high English proficiency widely used in business and education. The Philippines has the highest proportion of Catholics of any Southeast Asian country, and society places strong value on family and hospitality. Dress modestly when visiting Catholic churches, avoiding very short shorts or sleeveless tops. By law, service charges collected by hotels and restaurants must be distributed in full to employees, though the law does not require businesses to levy one; tipping beyond that is not an obligation. The voltage is 220V, with mostly American-style two-flat-pin or European two-round-pin outlets.",
    seeAndDo:
  ...
  manila: {
    ...
    culture:
      "The official languages are Filipino and English, with high English proficiency. Manila carries layered historical influences from Spanish colonial rule, American administration and local culture, and Catholic faith has broad influence on daily life. By law, service charges collected by hotels and restaurants must be distributed in full to employees, though the law does not require businesses to levy one; tipping beyond that is not an obligation.",
    seeAndDo:
  ...
  "iloilo-city": {
    // 全七段 sources: 同中文侧（PSA 2024 POPCEN regional highlights via PIA, tier 2 — psa.gov.ph blocked; Proclamation 973 of 2025-07-11 for the national figure; RA 12000 (2024-06-13) creating the Negros Island Region, tier 1; UNESCO Tentative List Ref. 6713 and World Heritage 677, tier 1; RA 11360 and the 2024 DOLE order on service charges, tier 1; OurAirports and computed distances）。 核实 2026-09-16 当批。 核实 2026-09-16 当批（同中文侧）。
    identity:
      "Iloilo City stands on the south-east coast of Panay in the Philippines, with about 474,000 people at the 2024 census (PSA). It is a highly urbanised city, outside the jurisdiction of Iloilo province yet still its capital; the Calle Real area of its old centre is the official name of one component on UNESCO's Tentative List.",
    howItWorks:
      "The city's status has two halves: as a highly urbanised city it is outside the provincial governor's authority, yet the provincial capitol stands within it because it is also the provincial capital. The mayor and council are directly elected, and the city's 180 barangays each have their own elected captain and council. The city is divided into seven districts — City Proper, Jaro, Molo, Mandurriao, La Paz, Arevalo and Lapuz — all of them formerly separate towns; they are not a tier of government, but locals give the district name first, and Jaro and Molo each keep their own church and plaza. In June 2024 an act split Negros Occidental, Negros Oriental and Siquijor off into a new Negros Island Region, leaving Western Visayas with five provinces and one city, and making Iloilo City the region's only highly urbanised city — so regional functions, the universities, hospitals, port and airport, all rest on this one city. What newcomers most often confuse is the name itself: the city and the province of Iloilo are separate, unconnected governments, the airport is in the provincial town of Cabatuan, and the World Heritage-listed Miagao church is in the provincial town of Miagao, about 37 km from the city in a straight line.",
    layout:
      "The old centre is City Proper, holding both Calle Real and Fort San Pedro, the fort about 1.5 km south-east of the old street by the harbour. Molo Church is about 2.8 km west of the centre and Jaro Cathedral and its belfry about 4 km north; the Iloilo River Esplanade and the newer business district are about 2 km north-west in Mandurriao, and the Museo Iloilo a short way north of the centre.",
    gettingAround:
      "Iloilo International Airport is about 18 km from the centre in a straight line and has scheduled flights, but it lies in the provincial town of Cabatuan rather than in the city. Ferries cross from the port to Guimaras island opposite and to Bacolod, about 41 km east in a straight line. Jeepneys and cars do the work within the city, which has no rail; addresses run house number, street, barangay, city. The climate is tropical and hot all year, with the rainy season roughly June to November, which is also the typhoon season.",
    culture:
      "Hiligaynon is the everyday language, with Filipino and English widely used. Calle Real keeps its rows of commercial buildings, and the churches of Jaro and Molo are local landmarks, so dress modestly when visiting. By law, service charges collected by hotels and restaurants must be distributed in full to employees, though the law does not require businesses to levy one — check the receipt to see whether service is included; tipping beyond that is not an obligation.",
    seeAndDo:
      "Calle Real; Jaro Cathedral and belfry; Molo Church; a walk along the Iloilo River Esplanade; the Museo Iloilo; Fort San Pedro by the harbour; and the ferry across to Guimaras.",
    whenAndTips:
      "December to May is relatively dry; June to November is the rainy and typhoon season, when ferries may be suspended, so check weather and sailing notices before you travel. The city is easy enough to walk, but the daytime sun is strong.",
  },

  banaue: {
    // 全七段 sources: 同中文侧（PSA 2024 POPCEN municipal highlights, tier 2 via search summary — psa.gov.ph blocked; Ifugao provincial government site on the municipality's class, barangays and road distances, tier 1; UNESCO 722, tier 1; RA 11360 and the 2024 DOLE order, tier 1; OurAirports and computed distances）。 核实 2026-09-16 当批。 核实 2026-09-16 当批（同中文侧）。
    identity:
      "Banaue (written as Banawe in the terrain entry of this library) is a mountain municipality in Ifugao province in northern Luzon, the Philippines, with 20,143 people at the 2024 census (PSA). The Rice Terraces of the Philippine Cordilleras, inscribed as World Heritage in 1995, consist of five clusters spread across four municipalities, and two of them — Batad and Bangaan — lie within Banaue.",
    howItWorks:
      "Ifugao province has eleven municipalities and not a single city; Banaue is a fourth-class municipality with a directly elected mayor and council under the provincial government, with the provincial capital Lagawe 24 km away by road, and its 18 barangays each have an elected captain and council chosen every three years. The town centre is a short stretch of street on a hillside — market, museum and bus stop within a few hundred metres — while everything the place is known for lies outside it: the roadside viewpoint a couple of kilometres away, the two World Heritage terrace clusters seven to nine kilometres out, reached by transferring to another vehicle and then walking. The thing most worth knowing is who owns the terraces: according to the World Heritage documentation each terrace is privately owned and maintained through ancestral rights, tribal law and traditional practice, while the provincial government and the National Commission for Culture and the Arts handle planning, restoration and nomination rather than ownership — so there is no single ticket covering everything. Newcomers often take the terraces seen from the roadside viewpoint for the World Heritage site, when the inscribed clusters here are Batad and Bangaan and the other three are in other municipalities; many also assume there is an airport nearby.",
    layout:
      "The town centre (Poblacion) runs along one hillside street, with the Banaue Museum in the middle of it. The main viewpoint is about 2.6 km north beside the road; the Batad terraces are about 8.5 km east, with Tappiya Falls below them, and the Bangaan terraces and village about 7 km east.",
    gettingAround:
      "Banaue has no airport with scheduled flights — there are two small airfields within about 40 km, but neither has scheduled service, and the nearest airport that does is Cauayan in Isabela province, about 74 km away in a straight line and rarely used to reach here. Most people take an overnight long-distance bus from Manila, about 341 km by road. Jeepneys and tricycles serve the municipality; reaching Batad means changing vehicles and then walking, and conditions vary with the season, so ask locally before setting out. The mountain climate is cooler than the lowlands, and paths are slippery in the wet season.",
    culture:
      "Ifugao is spoken locally, with Filipino and English widely used. The terraces are private, inherited property, so ask before entering fields or villages and keep off the walls and irrigation channels. By law, service charges collected by hotels and restaurants must be distributed in full to employees, though the law does not require businesses to levy one; tipping beyond that is not an obligation.",
    seeAndDo:
      "The Batad terraces and Tappiya Falls below them; the Bangaan terraces and village; the roadside main viewpoint; the Banaue Museum in town; and a walk along the paths between the terraces near the centre.",
    whenAndTips:
      "The dry season, roughly December to April, means better paths and clearer views; the wet season brings slippery trails and fog. Getting into the terraces means loose stone and narrow walls, so wear shoes with grip — and hiring a local guide is both safer and a source of local income.",
  },

  bacolod: {
    // 全七段 sources: 同中文侧（PSA OpenSTAT table 0191A6DTHP8.px, 2024 census with reference date 1 July 2024, tier 1, digit-checked 3/3 against the national, NCR and Iloilo City figures already in the repo; RA 12000 full text via the Supreme Court E-Library for the cluster split, tier 1; PSA barangay table 0181A6DTHP7.px, tier 1; PHIVOLCS live bulletin for Kanlaon at alert level 2 as of 16 September 2026, tier 1; distances computed from this entry's own coordinates. Land area: two tier-1 sources disagree — 160.68 km² (PSA) vs 162.67 km² (city government), so the text says "about 160 km² (PSA)"）。 核实 2026-09-17 当批。
    identity:
      "Bacolod stands on the north-western coast of Negros in the central Philippines, with 624,787 people at the 2024 census (Philippine Statistics Authority) over about 160 km². It faces the Guimaras Strait with Kanlaon volcano behind it; sugar growing and milling shaped the place, leaving old houses and mill works scattered in and around the city, and every October it holds a masked carnival.",
    howItWorks:
      "One thing about this city is unusual in the Philippines: the region it belongs to has no regional capital at all. The 2024 law that created the Negros Island Region split the regional offices between the two provinces by cluster — foreign affairs and the economic planning agency on this side, tourism and the statistics authority on the other side of the island. So \"go to the regional office\" here always begins with which department. The city itself is a highly urbanised city, independent of the province, and yet it is also the capital of Negros Occidental, whose capitol stands in town: two governments, each minding its own. A layer further down is equally counter-intuitive: of the city's sixty-one barangays, the forty-one in the centre have numbers rather than names, and people give addresses as \"Barangay so-and-so number\". Some of those numbered barangays hold barely a hundred-odd people, while the named ones on the outskirts hold forty to fifty thousand each. The old core is a small walkable ring; the weight of the city is outside it.",
    layout:
      "The city plaza is the centre of the old town, with San Sebastian Cathedral on its north-eastern corner. The Negros Museum is about 0.8 km north-north-east, the provincial capitol and its park about 0.9 to 1 km north-north-east, and the new city hall about 2.5 km east-south-east. Panaad Park and Stadium is about 5.5 km south-south-east, and The Ruins about 6 km north-east, in the neighbouring city of Talisay.",
    gettingAround:
      "Bacolod–Silay International Airport is about 14 km north-north-east in a straight line, with domestic and international scheduled flights — it lies in the city of Silay to the north, not within Bacolod itself. Jeepneys and tricycles carry local traffic, buses run to the other towns of the island, and ferries cross the strait. The climate is tropical monsoon, hot all year with the wet months from June to November.",
    culture:
      "Hiligaynon is spoken, with English and Tagalog in general use. The sugar era left the old houses, the sweets and much of the local cooking; the October carnival is the busiest week of the year, with dates announced annually. Restaurant bills often already include a service charge, and anything beyond it is voluntary.",
    seeAndDo:
      "The plaza and the cathedral; the Negros Museum for what the sugar century left behind; a walk around the capitol park and its lagoon; The Ruins over in Talisay to the north-east; and the parade if you are here for the October carnival.",
    whenAndTips:
      "December to May is the drier stretch. As of September 2026 Kanlaon is at alert level 2 with its four-kilometre permanent danger zone closed, so anything on or near the mountain follows official bulletins; the city is some thirty-five kilometres north-west of the crater and unaffected day to day, though ashfall advisories are worth watching.",
  },

  angeles: {
    // 全七段 sources: 同中文侧（PSA OpenSTAT 2024 census, same table and same digit check; the Clark Freeport's legal basis — the 1992 Bases Conversion and Development Act, managed by BCDA and CDC across Angeles and Mabalacat — tier 2, so the text names the law and the year but quotes no provision; PSA barangay table for Balibago 38,510 vs Sto. Rosario 6,476, tier 1; PHIVOLCS for Pinatubo at alert level 0 as of 16 September 2026, tier 1; distances computed from this entry's own coordinates, which are the city hall — the old town lies about 4 km south-south-west）。 核实 2026-09-17 当批。
    identity:
      "Angeles lies in Pampanga in central Luzon, with 483,452 people at the 2024 census (Philippine Statistics Authority) over about 63 km². The Clark Freeport and Special Economic Zone adjoins it on the west with the international airport inside that zone, and Mount Pinatubo stands some twenty-eight kilometres further west.",
    howItWorks:
      "The largest single piece of land in this city is not run by the city. The Clark Freeport and Special Economic Zone was created under the 1992 Bases Conversion and Development Act and is run by the Bases Conversion and Development Authority and its subsidiary, the Clark Development Corporation, across the territory of both Angeles and Mabalacat — so within one city, land use, licensing and the municipal system inside the zone belong to two different regimes, and even the airport falls administratively to Mabalacat next door. Angeles itself is a highly urbanised city, independent of Pampanga province, while the provincial capital is another city, San Fernando. Bacolod, written in the same batch, is the mirror image: independent of its province but still its capital; here, independent and not the capital either. The commonest misconception among visitors is that the old town is the centre: the barangay that holds it has only about 6,500 people, while Balibago, up by the zone's main gate, has 38,500 and is the largest in the city — the centre of gravity moved north along the line from the old town to the zone long ago. So people say \"the old town\", \"Balibago\" or \"Clark\" first, and the street second.",
    layout:
      "The city hall stands in the northern part of town. The old town's Holy Rosary church, the city museum, the Pamintuan Mansion and the Kapampangan studies centre are all about 3.8 to 4.1 km south-south-west, within a few hundred metres of each other. Bayanihan Park by the Clark main gate is about 2.3 km due west and the Clark Museum about 8.9 km west-north-west. The Pinatubo crater is about 28 km due west.",
    gettingAround:
      "Clark International Airport is about 5.6 km west-north-west in a straight line, with domestic and international scheduled flights — it sits inside the Clark Freeport and belongs administratively to Mabalacat. Jeepneys and tricycles carry local traffic, and expressways and coaches run towards Manila. The climate is tropical monsoon, hottest from March to May and wet from June to October.",
    culture:
      "Kapampangan is spoken, with English and Tagalog in general use. Pampanga is known for its cooking, and the local restaurants are one of the reasons to come. Restaurant bills often already include a service charge, and anything beyond it is voluntary.",
    seeAndDo:
      "The old town circuit — the Holy Rosary church, the city museum, the Pamintuan Mansion and the Kapampangan studies centre, all within a walk of each other; the museum inside the Clark zone and the park by its main gate; and Mount Pinatubo using the city as a base, though the usual trips start from a village in Tarlac province rather than from town.",
    whenAndTips:
      "November to February is the most comfortable and March to May is very hot. Pinatubo was at alert level 0 in September 2026, but the four-wheel-drive routes close often in the wet season when the river channels rise, so check the day's status first; the zone and the old town are several kilometres apart, so plan around two centres rather than one.",
  },
};
