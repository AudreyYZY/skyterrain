...
// 本国惯例（服务费）2026-09-16 更新：土耳其贸易部 2026-01-30 公布《价格标签条例》修订后，餐饮场所不得再以服务费 / 餐位费 / 桌费等名目收取商品价格之外的费用，消费者只能自愿给小费（ticaret.gov.tr，1 级）。原来 11 个条目统一写的「先看账单是否已含服务费」自 2026 年起不再成立，本次一并改掉。罚款金额与官方公报的确切生效日属会变 / 未取到的量，不写。
...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "turkey-overview": {
    ...
    culture:
      "土耳其是以突厥语族穆斯林为主体的世俗共和国，宪法规定政教分离，多数居民信奉伊斯兰教（逊尼派为主），社会整体氛围较为温和开放，饮酒合法且普遍可得，斋月期间白天在公共场合进食饮水虽不违法，但作为礼貌宜适当低调。进入清真寺需脱鞋，女性需备头巾、衣着覆盖肩膀与膝盖；餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  istanbul: {
    ...
    culture:
      "官方语言土耳其语。进入圣索菲亚大教堂或蓝色清真寺等宗教场所，女性需备头巾、衣着覆盖肩膀与膝盖，男女均需脱鞋，非祈祷时段游客可参观但应保持安静；餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  ankara: {
    ...
    culture:
      "官方语言土耳其语。安卡拉作为行政中心，衣着与礼仪整体较为正式；进入宗教场所仍需脱鞋、女性备头巾。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  izmir: {
    ...
    culture:
      "官方语言土耳其语。伊兹密尔是滨海度假与商贸氛围较浓的城市，日常衣着以休闲为主；进入清真寺仍需遵守脱鞋、女性备头巾等基本礼仪。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  antalya: {
    ...
    culture:
      "官方语言土耳其语。安塔利亚是土耳其最重要的国际旅游城市之一，衣着相对自由，海滩着泳装普遍可接受；进入清真寺仍需脱鞋、女性备头巾。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  cappadocia: {
    ...
    culture:
      "官方语言土耳其语。区域旅游业发达，多数从业者习惯与国际游客打交道；进入岩凿教堂等宗教历史场所应保持安静、不触碰壁画；热气球飞行前建议确认公司资质与安全记录，餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  bodrum: {
    ...
    culture:
      "官方语言土耳其语。博德鲁姆是土耳其国际化程度较高的度假城市之一，衣着相对自由；进入清真寺仍需脱鞋、女性备头巾。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  pamukkale: {
    ...
    culture:
      "官方语言土耳其语。进入钙化梯田水池需赤脚行走以保护地质结构，部分区域游客较为拥挤，建议尽量早到避开团队高峰。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  trabzon: {
    ...
    culture:
      "官方语言土耳其语，当地黑海方言与文化风俗较为独特。特拉布宗黑海沿岸整体气候湿润多雨，出行宜备雨具；进入清真寺仍需脱鞋、女性备头巾。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  konya: {
    ...
    culture:
      "官方语言土耳其语。科尼亚是土耳其宗教氛围相对保守浓厚的城市之一，建议着装相对保守得体；进入梅夫拉纳博物馆与清真寺需脱鞋，女性需备头巾。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  bursa: {
    ...
    culture:
      "官方语言土耳其语。进入布尔萨大清真寺、绿色清真寺等宗教场所需脱鞋，女性需备头巾、衣着覆盖肩膀与膝盖。餐厅小费不是强制的，服务满意时可以留一些，2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
  ...
  safranbolu: {
    // 全七段 sources（2026-09-16 首写，已有城市补充批；研究子代理事实表 scratchpad/tr-is-cities-facts.md §0、§1）：
    //   人口：TÜİK ADNKS 2025（基准日 2025-12-31，发布 2026-02-09）萨夫兰博卢区 69,592、其中区中心 52,343、卡拉比克省 249,614（省级与全国数在 TÜİK 公报原文核对，1 级；区级数为地方媒体转引 TÜİK，3 级，与萨夫兰博卢县长公署页面的 69,592 互证）。下一期约 2027-02。**只写「区（ilçe）人口」，不写「市政府辖区人口」**（县长公署把区的数挂在市政府名下，口径含糊）。
    //   行政：卡拉比克不是大都会省 —— 省长（中央任命）→ 县长（中央任命）→ 一个民选市政府；县长公署页面列「市政府 1 / 镇 0 / 社区 21 / 村 60」（safranbolu.gov.tr，1 级）。遗产保护由市政府负责，注册建筑的任何物理干预与功能变更须经区域保护委员会批准、2008 年划定缓冲区（UNESCO 614 页面，1 级）。
    //   UNESCO 614「萨夫兰博卢城」1994 年列入，标准 (ii)(iv)(v)，遗产面积 193 ha；三个历史街区 Çukur / Kıranköy / Bağlar；半木构民居、临街立面不开窗、石板路向内倾排水；商队贸易衰落后因靠近卡拉比克钢铁厂获得新的社会经济角色、原有形态得以保住（UNESCO，1 级）。
    //   ⚠️ UNESCO 原文用「非穆斯林街区」描述 Kıranköy —— **不照搬宗教 / 族群描述**，只写建成形态差异（石砌 vs 木构）。
    //   历史：1196 年塞尔柱一方在城堡台地确立统治、伊本·白图泰 1332 年到访、1326 年詹达尔奥卢取得此城、奥斯曼首次取得约 1354 年（县长公署 Tarihçe，1 级）。地名与藏红花有关、当地物产有藏红花软糖（县长公署列举，1 级；种植规模与地理标志状态 unknown）。
    //   交通：55 km 内无任何机场记录；ONQ 直线约 58 km 但 2026 年只有国际定期航班（3 级）、KFS 约 93 km、ESB 约 127 km（算）。本地无在用客运火车站，最近是约 9 km 外的卡拉比克站（3 级，班次与时长不写）。
    //   本国惯例：2026-01-30 土耳其贸易部公布《价格标签条例》修订后，餐饮场所不得再收服务费 / 餐位费 / 桌费（ticaret.gov.tr，1 级）；罚款金额与官方公报生效日不写。插座、自来水无 1 级来源，不写。
    //   不写：街区的宗教 / 族群属性、20 世纪政治、人名与党派、钢铁厂的产业评价、航点与班期。 核实 2026-09-16 当批。 核实 2026-09-16 当批（content-verifier 独立检索：县长公署页面现在只剩隐私声明、另外两个来源的社区与村数互相矛盾，正文已删去具体数目；其余全部 ok）。
    identity:
      "萨夫兰博卢是土耳其黑海地区卡拉比克省的一个区，2025年底全区人口69,592、其中区中心52,343（土耳其统计局）。老城1994年以“萨夫兰博卢城”列入世界遗产，遗产范围193公顷，保住的是一整座奥斯曼城镇的形态——半木构的宅子、向内倾斜排水的石板路、临街不开窗的石墙。名字里的“萨夫兰”就是藏红花，当地至今种植，也做藏红花软糖。",
    howItWorks:
      "卡拉比克省不是大都会省，所以这里是三层：省长和县长都由中央任命，本地只有一个民选的市政府；区里只有一个市政府，此外是若干社区与村，各有自己的穆赫塔尔（具体数目各来源不一，这里不列）。老城的事还要多过一道关：按联合国教科文组织的说明，保护由市政府负责，但注册建筑的任何改动与功能变更都要经区域保护委员会批准，缓冲区是2008年划的——买下一栋老宅想换扇窗，要过的是省一级的委员会。城镇本身不是一个中心而是两个：谷地里的老城市场区（客栈、清真寺、木构民居都在这里），坡上的基兰柯伊是学校、医院、超市所在的新城，再往山坡上是过去做夏季住所的葡萄园区。生活半径由地形和9公里外的卡拉比克决定：省会在那边，有钢铁厂、有火车站，人口是这里区中心的两倍多。初来的人常把萨夫兰博卢当成卡拉比克的老城区，其实它是一个独立的区，游客看到的那片老城也只是全区六万多人里的一小块。",
    layout:
      "老城在两条河围出的谷地里：钟楼在城堡台地上、在市场区西北，琴吉客栈和伊泽特·迈赫迈特帕夏清真寺就在市场中央一带，“县长宅”民居博物馆在客栈东边。赫德尔勒克山丘在老城东南，是俯瞰整片屋顶的观景点。新城基兰柯伊在坡上；因杰卡亚引水渠与托卡特勒峡谷在老城以北直线约4公里，布拉克溶洞在西北约6公里。",
    gettingAround:
      "萨夫兰博卢没有定期航班的机场，附近几十公里内也查不到别的机场；最近的两座里，宗古尔达克机场直线约58公里、卡斯塔莫努机场直线约93公里，多数人实际从安卡拉的机场（直线约127公里）走。本地没有在用的客运火车站，最近的火车站在直线约9公里外的卡拉比克，有开往安卡拉方向的列车；安卡拉和伊斯坦布尔都有长途大巴过来。老城步行即可，但谷地与坡上的新城之间是上下坡。属黑海内陆的气候，冬季冷、夏季不酷热。",
    culture:
      "官方语言是土耳其语。进入清真寺要脱鞋、女性备头巾，衣着覆盖肩膀与膝盖。餐厅小费是自愿的；2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。",
    seeAndDo:
      "老城市场区与琴吉客栈；钟楼与城堡台地上的城市史博物馆；伊泽特·迈赫迈特帕夏清真寺；“县长宅”民居博物馆；赫德尔勒克山丘看屋顶；城外的因杰卡亚引水渠与托卡特勒峡谷；布拉克溶洞。",
    whenAndTips:
      "4–6月与9–10月气候宜人；老城的石板路陡而滑，穿防滑的鞋。老宅改成的民宿很多，房间大小与楼梯差别大，订前看清楚。",
  },

  amasya: {
    // 全七段 sources（2026-09-16 首写，已有城市补充批；研究子代理事实表 scratchpad/tr-is-cities-facts.md §0、§2）：
    //   人口：TÜİK ADNKS 2025（基准日 2025-12-31，发布 2026-02-09）阿马西亚省 342,242（内政部人口与公民事务总局阿马西亚分局公告，1 级，比上一年减少 136 人）；中心区 151,433（nufusu.com 转引 TÜİK，3 级 —— 区级一手表需 JS，取不到，与既有博德鲁姆条目的处理一致）。**每个数字写清是省还是中心区，不写「市区 / 城区 / 都会区」**（土耳其统计里没有这些口径）。
    //   行政：阿马西亚省不是大都会省；省长公署的县长菜单只列 6 位、恰好是 6 个非中心区 ⇒ 中心区没有县长、由省长直管（amasya.gov.tr，1 级旁证 + 推断，正文写「由省长直管」，措辞保守）。市政府民选。
    //   认定：UNESCO 预备名单 6039「哈尔谢纳山与本都诸王岩凿墓」2015-04-13 列入（1 级）——**是预备名单，不是世界遗产**，正文写清楚。
    //   地标年代：哈泽兰宅 1865 年建、1984 年开放为博物馆（3 级）；巴耶济德二世清真寺约 1484–1488（3 级，年份两说，正文只写「15 世纪末」）；费尔哈特引水渠只写工程、传说一句带过不作历史。
    //   交通：MZH 在梅尔济丰区、直线约 33 km，有国内定期航班（按规则 ⑫ 不列航点）；火车站在市内、萨姆松—锡瓦斯线上的区域列车（3 级，票价不写）。
    //   ⚠️ 坐标陷阱：Nominatim 查「Amasya Saat Kulesi」返回的是梅尔济丰区的钟楼；写完 layout 跑 check:layout-bearings。
    //   本国惯例：同 safranbolu（土耳其贸易部 2026-01-30，1 级）。
    //   不写：1919 年的阿马西亚通告 / 会议及其纪念场所与建国叙事、传说当史实、族群与方言、人名与党派、航点班期与票价。 核实 2026-09-16 当批。 核实 2026-09-16 当批（content-verifier 独立检索，本条全部 ok，含「中心区由省长直管」）。
    identity:
      "阿马西亚是土耳其黑海地区阿马西亚省的省会，2025年底中心区人口151,433、全省342,242（土耳其统计局）。城市夹在耶希尔河与两侧的岩壁之间，北岸岩壁上凿着本都诸王的岩墓——哈尔谢纳山与这些岩墓2015年进入联合国教科文组织的世界遗产预备名单（是预备名单，还不是世界遗产）。",
    howItWorks:
      "阿马西亚省也不是大都会省，省长由中央任命；全省7个区里有6个各有一位中央任命的县长，省会所在的中心区没有县长、由省长直管，另有一个民选的市政府——这一层是外来者不会想到的。城市的形状由地形决定：耶希尔河把老城切成南北两条带，两岸背后就是岩壁，城市因此只能沿河拉长。北岸是岩凿王墓与城堡所在的哈尔谢纳山，南岸是15世纪末的巴耶济德二世清真寺与主要街道，河岸上是成排的奥斯曼木宅。省公署自己列出的一条是：有7位在这里当过皇子的人后来登上了奥斯曼皇位——这座城在奥斯曼早期是皇子历练的地方。生活半径上有两件事容易误会：一是以为阿马西亚临黑海，它在官方区划里属黑海区域，但离海还有直线约90公里；二是以为机场在本市，机场其实在33公里外的梅尔济丰区。",
    layout:
      "耶希尔河穿城而过：南岸是巴耶济德二世清真寺与阿马西亚博物馆，清真寺在市中心西边、博物馆再往西；哈泽兰宅在河边、市中心西北不远，河岸木宅沿两岸排开。北岸抬起就是哈尔谢纳山，本都诸王岩凿墓在山腰、城堡在山上，都在市中心西北一公里以内。费尔哈特引水渠在城西南直线约2公里。",
    gettingAround:
      "阿马西亚梅尔济丰机场在梅尔济丰区、离市区直线约33公里，有国内定期航班。市内有火车站，在萨姆松通往锡瓦斯方向的线路上，跑的是区域列车；安卡拉与萨姆松方向的公路干线也经过这里。老城沿河一带步行即可，上城堡与岩墓要爬坡或开车。属黑海内陆的气候，比沿海干燥。",
    culture:
      "官方语言是土耳其语。进入清真寺要脱鞋、女性备头巾，衣着覆盖肩膀与膝盖。餐厅小费是自愿的；2026年1月土耳其修订价格标签条例后，餐饮场所不得再收服务费、餐位费一类的强制性附加费用（土耳其贸易部）。当地苹果有名，省的标识上就画着苹果树。",
    seeAndDo:
      "本都诸王岩凿墓与哈尔谢纳山上的城堡；耶希尔河两岸的奥斯曼木宅；哈泽兰宅；巴耶济德二世清真寺；阿马西亚博物馆；城西南的费尔哈特引水渠。",
    whenAndTips:
      "4–6月与9–10月气候宜人；上岩墓和城堡要爬台阶与坡道，穿合脚的鞋。河两岸夜里灯光打在岩墓上，适合沿河散步。",
  },
};
