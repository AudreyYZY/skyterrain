...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  kuusamo: {
    ...
    layout:
      "The town itself is small; the Ruka ski resort lies about 22 km in a straight line to the north, and Oulanka National Park lies further north still, near the Finland-Russia border.",
    gettingAround:
  ...
  rauma: {
    // 全七段 sources: 同中文侧（Statistics Finland StatFin 11ra via PxWeb, tier 1; Rauma administrative regulations and Local Government Act 410/2015, tier 1; UNESCO 582 and 579, tier 1; Finnish Heritage Agency, tier 1; Finnish Transport Infrastructure Agency 2026-04-08, tier 1; Finavia 2026-06, tier 1; Visit Finland, tier 1; distances computed）。 核实 2026-09-16 当批（content-verifier 独立检索，本条全部 ok）。
    identity:
      "Rauma is a port town on Finland's south-west coast in the Satakunta region, with a municipal population of about 38,800 at the end of 2025 (Statistics Finland). Its territory holds two World Heritage sites: Old Rauma, a wooden town inscribed in 1991, and the Bronze Age burial site of Sammallahdenmäki, inscribed in 1999. Old Rauma's roughly 600 wooden houses are still lived in and trade from, and the town already held town rights in 1442.",
    howItWorks:
      "Rauma is governed by an elected 43-seat city council, which chooses the city board and appoints a city manager to run the administration — in Finland the city manager is a civil servant chosen by the council, not an elected mayor; since 2023 health care, social services and rescue services have belonged to the Satakunta wellbeing services county. The centre of town is the World Heritage old town itself: the market square, the old town hall and the shopping streets are all within this wooden town, which is not a museum quarter but a living residential and commercial centre. Land uplift has pushed the once-seaside old town away from the shore, so today it stands about 1.5 km inland (according to UNESCO), with the port and industry further out. After neighbouring Lappi merged into Rauma in 2009 the town's territory reached further east, and the Bronze Age burial site lies in former Lappi. Newcomers often assume Rauma has trains, when as of September 2026 it has no passenger rail service, with its return planned for spring 2027; many also think Rauma has only one World Heritage site.",
    layout:
      "Old Rauma is in the town centre, with the market square and old town hall in its middle, the Church of the Holy Cross on its north side and the Marela shipowner's house and Kirsti sailor's home museums in its eastern part; the modern town and the port lie around it. About 14 km east in a straight line is the Sammallahdenmäki burial site, and about 11 km west, out at sea, is the lighthouse island of Kylmäpihlaja.",
    gettingAround:
      "Rauma has no airport with scheduled flights; the nearest is Pori Airport, about 40 km away in a straight line, which flies only to Helsinki, and more flights go through Turku or Helsinki. As of September 2026 Rauma has no passenger trains, with service towards Tampere planned to resume in spring 2027, so for now long-distance buses and cars are the way in. The old town is walkable, and the burial site needs a car.",
    culture:
      "Finnish is spoken, and Rauma has a distinctive local dialect. Bobbin lace is Rauma's traditional craft, celebrated every July in Lace Week, which in 2026 was held for the 56th time. In Finland service is included in prices, so there is no need to tip; cards and mobile payments are accepted almost everywhere, and tap water is safe to drink.",
    seeAndDo:
      "The wooden town and market square of Old Rauma; the Rauma Museum in the old town hall; the Marela shipowner's house museum; the Church of the Holy Cross; the Bronze Age burial site of Sammallahdenmäki; and Lace Week in summer.",
    whenAndTips:
      "June–August is the most comfortable, with the longest days, and the town is liveliest during Lace Week in July; winters are cold with short days. Most houses in the old town are private homes, so don't wander into courtyards and disturb residents.",
  },
  vaasa: {
    // 全七段 sources: 同中文侧（Statistics Finland 11ra, tier 1; Government decree 1385/2022, tier 1; vaasa.fi, tier 1; Finnish Heritage Agency RKY and World Heritage pages, tier 1; UNESCO 898, tier 1; ELY Centre and Yle on the Replot Bridge, tier 1/2; Fintraffic timetable 2026-09-17, tier 1; wasaline.com, tier 1; Visit Finland, tier 1; distances computed）。 核实 2026-09-16 当批（content-verifier 独立检索，上诉法院设立年份改为 1775 年设立、1776 年开始审理；火车时长以 Fintraffic 时刻数据为准，其余 ok）。
    identity:
      "Vaasa is the capital of Ostrobothnia on Finland's west coast, facing Sweden across the Kvarken, the narrowest part of the Gulf of Bothnia, with a municipal population of about 71,200 at the end of 2025 (Statistics Finland). It is a bilingual city with Finnish as the majority language and the gateway to the Kvarken Archipelago World Natural Heritage site; today's city is a new town rebuilt about 6 km in a straight line from the old site to a fire-safety plan after the great fire of 1852.",
    howItWorks:
      "Vaasa is governed by a 55-seat city council, which chooses the city board and appoints a city manager to run the administration; health care, social services and rescue services belong to the Ostrobothnia wellbeing services county, and the city is also home to the Vaasa Court of Appeal, founded in 1775 and in session from 1776. The fire of 1852 all but destroyed the old town founded in 1606, and the new town was rebuilt about 6 km in a straight line from the old site to a plan approved in 1855 that divides the blocks with five intersecting central esplanades and narrow firebreak lanes, placing the market square, church and town hall between the esplanades — that fire-safety grid is still the city centre. Vaasa is bilingual, with two official names, Vaasa in Finnish and Vasa in Swedish, though most residents speak Finnish. Newcomers often assume the World Heritage archipelago is on the edge of town, when the core of the Kvarken site is in the neighbouring municipality of Korsholm and the Replot Bridge is about 14 km from the centre in a straight line; they also take today's Vaasa for the 17th-century town, when only the ruins of Old Vaasa remain.",
    layout:
      "The centre is the grid of the 1855 plan with the market square in the middle, Vaasa Church and the Court of Appeal south-west of the square, and the Ostrobothnian Museum with the Terranova Kvarken nature centre and the Kuntsi Museum of Modern Art to the west near the inner harbour; the railway station is a short way north-east of the square. About 6 km south-east in a straight line are Old Vaasa and the ruins of St Mary's Church; north over the Replot Bridge lies the Kvarken Archipelago in Korsholm, and the port is on the west side of the city.",
    gettingAround:
      "Vaasa Airport (VAA), about 9 km from the centre in a straight line, has scheduled flights and regional buses into town. Direct trains from Helsinki to Vaasa take about 3 hours 40 minutes to 4 hours 15 minutes. From Vaasa's port a ferry crosses to Umeå in Sweden in about 4 hours. The city is easy on foot or by bike; the bridgehead and fishing harbours of the Kvarken Archipelago need a car.",
    culture:
      "Vaasa is bilingual, mainly Finnish-speaking with Swedish often heard too, and English is widely used in tourism. The Terranova Kvarken nature centre in the Ostrobothnian Museum explains land uplift and how the archipelago formed. In Finland service is included in prices, so there is no need to tip; cards and mobile payments are accepted almost everywhere, and tap water is safe to drink.",
    seeAndDo:
      "The market square and esplanades; Vaasa Church; the Ostrobothnian Museum and Terranova Kvarken nature centre; the Kuntsi Museum of Modern Art; the ruins of St Mary's Church in Old Vaasa; and a trip over the Replot Bridge to the Kvarken Archipelago to see coastlines and moraines shaped by land uplift.",
    whenAndTips:
      "June–August is the most comfortable, with the longest days and the best time for the archipelago; winters are cold and the sea freezes. Visitor facilities in the Kvarken Archipelago are seasonal, so check the managing authority's announcements before setting off.",
  },
};
