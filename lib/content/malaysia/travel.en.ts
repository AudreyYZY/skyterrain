...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  "kuala-lumpur": {
    ...
    gettingAround:
      "Kuala Lumpur International Airport is about 45 km in a straight line from the city centre; the KLIA Ekspres train takes about 28 minutes direct to downtown. The city's LRT, monorail and MRT network covers major attractions, and Grab ride-hailing is widely used.",
    culture:
  ...
  sandakan: {
    ...
    seeAndDo:
      "A wildlife river cruise on the Kinabatangan (proboscis monkeys, orangutans); Sandakan Central Market; the Sepilok Orangutan Rehabilitation Centre (on the outskirts).",
    whenAndTips:
