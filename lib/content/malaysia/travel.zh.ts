...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "johor-bahru": {
    ...
    gettingAround:
      "士乃国际机场距市区直线约18公里；新柔长堤与第二通道大桥连接新加坡，跨境巴士与私家车往来频繁，通勤高峰时段口岸常有拥堵。",
    culture:
  ...
  "kota-kinabalu": {
    ...
    gettingAround:
      "亚庇国际机场距市区公路约7公里，是沙巴最主要的航空枢纽；市内出租车与网约车Grab均可便捷抵达周边景点，前往京那巴鲁山需公路自驾或包车约2小时。",
    culture:
  ...
  kuching: {
    ...
    gettingAround:
      "古晋国际机场距市区公路约11公里；前往姆鲁山国家公园需转乘国内航班至美里或姆鲁机场，前往尼亚洞穴则需公路前往美里方向。",
    culture:
  ...
  "kota-bharu": {
    ...
    gettingAround:
      "苏丹依斯迈布特拉机场距市区直线约8公里；从吉隆坡可乘国内航班直达，也可经陆路前往大汉山国家公园方向。",
    culture:
  ...
  kuantan: {
    ...
    gettingAround:
      "苏丹哈芝阿末沙机场距市区直线约14公里；从吉隆坡乘国内航班或长途巴士（约4小时车程）均可到达，前往琴宁湖需公路自驾约1.5小时。",
    culture:
  ...
  sandakan: {
    ...
    gettingAround:
      "山打根机场距市区直线约9.4公里；前往京那巴当岸河下游野生动物保护区需公路自驾约2小时，部分行程需转乘船只。",
    culture:
  ...
  miri: {
    ...
    gettingAround:
      "美里机场距市区直线约8.6公里；前往姆鲁山国家公园需转乘小型飞机（约30分钟航程），前往尼亚洞穴则可公路自驾约1.5小时。",
    culture:
  ...
  "langkawi-city": {
    ...
    howItWorks:
      "浮罗交怡是吉打州西北海上的 99 座岛组成的群岛，主岛南北约 25 公里，由浮罗交怡市议会管辖，议员由州政府任命；2020 年人口普查全岛约 9.4 万人，其中约 6.5 万在主岛，九成是马来人。1987 年起全岛免税，这是它的经济基础；瓜镇在东南角，是县政府、渡轮码头与本地人购物的地方，珍南海滩在西南角，是游客的旅馆带，两者相距公路约 20 公里；机场在中部的巴东马硕，东方村的缆车通往马西琅山顶的天空之桥，2007 年整片群岛成为联合国教科文组织的世界地质公园，渡轮从瓜拉玻璃市、瓜拉吉打与槟城开来。初来的人最容易犯的错，是把瓜镇当作度假区，而海滩在岛的另一头，没有车寸步难行。",
    layout:
  ...
  putrajaya: {
    ...
    howItWorks:
      "布城是马来西亚 2001 年设立的第三个联邦直辖区，约 49 平方公里，2025 年人口约 12.1 万，绝大多数是公务员与家属。它不是自然长出来的城市，而是 1995 年动工、1999 年起把首相署与各部委从吉隆坡整体迁来的行政首都；管理它的是布城机构（Putrajaya Corporation），不是民选议会，全城按 20 个“分区”规划，首相署的绿顶建筑在人工湖畔的高地上，司法宫在另一端，布城清真寺与广场在中间，湖与桥是规划的骨架。宪法上的首都仍是吉隆坡，国会与国家元首都在那里；机场快线与地铁把它与吉隆坡、机场连起来，赛城在隔壁的雪兰莪州。初来的人最容易犯的错，是把布城当作首都，而它只是政府办公的地方，国会在 直线约 25 公里外的吉隆坡。",
    layout:
  ...
  "alor-setar": {
    ...
    gettingAround:
      "苏丹阿都哈林机场（AOR）距市区直线约9公里，有定期国内航班。ETS 电动列车从吉隆坡约5–6小时、从北海约1小时；大巴从吉隆坡约6小时、槟城约2小时。市内打车、租车，市中心步行；去稻米博物馆和瓜拉吉打打车。属热带季风气候，5–10月雨季。",
    culture:
  ...
  semporna: {
    ...
    howItWorks:
      "仙本那是沙巴东海岸的一个镇与县，由县议会管辖，议员由州政府任命；县域 2025 年人口约 20.1 万，巴瑶族是主要族群，还有苏禄人、菲律宾人与客家华人，是马来西亚唯一有查瓦卡诺语社群的地方。镇子本身很小，一条海边的街与水上木屋村，海鲜市场是它的中心；它是潜水的出发港：西巴丹岛在东南 36 公里，每天限量发放许可、只能当天往返，马布岛与卡帕莱的水上屋在附近，敦沙卡兰海洋公园的博安波岛在北面；最近的机场在斗湖，公路约 80 公里。这一带属于沙巴东海岸安全区，出行前应查最新的旅行提示。初来的人最容易犯的错，是以为可以住在西巴丹岛上，而岛上不许过夜，潜水者住在马布或镇上。",
    layout:
  ...
  sibu: {
    ...
    gettingAround:
      "诗巫机场（SBW）距市区直线约17公里，有国内与国际定期航班。从古晋坐大巴约7小时；拉让江快艇是去内陆的传统方式。市内打车，市镇步行；去长屋跟当地旅行社。属热带雨林气候，全年炎热多雨。",
    culture:
