...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "malaysia-overview": {
    ...
    seeAndDo:
      "自然地貌：京那巴鲁山、姆鲁山国家公园尖峰石林与洞穴、浮罗交怡地质公园、热浪岛与停泊岛海洋公园。历史人文：马六甲与乔治市UNESCO世界遗产老城区、黑风洞。雨林生态：丹浓谷与马利吾盆地原始雨林、京那巴当岸河野生动物观察。",
    whenAndTips:
  ...
  sandakan: {
    ...
    //   同上。
    howItWorks:
      "山打根是沙巴的第二大城市，由山打根市议会管辖，议员由州政府任命；县域 2025 年人口约 50.5 万。1884 至 1946 年它是英属北婆罗洲的首府，香港来的华人移民让它有“小香港”之称，二战的轰炸把整座城夷平，战后首府迁到了亚庇，山打根按新规划重建；今天它是棕榈油与木材的出港口，海湾边的市区不大，普济寺在山上，作家艾格尼丝·基思的故居是英治时期的遗存；西比洛的红毛猩猩保护中心在西面 25 公里，京那巴当岸河在南面约 100 公里，机场在城郊。初来的人最容易犯的错，是把山打根当作看野生动物的地方，而动物在几十到上百公里外的保护区，城本身是一座港口。",
    layout:
    ...
    seeAndDo:
      "京那巴当岸河野生动物游船（长鼻猴、红毛猩猩观察）；山打根中央市场；沙比洛红毛猩猩康复中心（近郊）。",
    whenAndTips:
