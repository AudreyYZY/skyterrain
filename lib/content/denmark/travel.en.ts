...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  vejle: {
    // 全七段 sources: 同中文侧（Statistics Denmark BY1 and FOLK1A, tier 1; vejle.dk on the 31-seat council, tier 1; UNESCO 697 Jelling, tier 1; VisitDenmark on service charges, tier 1; Danish EPA on tap water, tier 1; Danish Safety Technology Authority on plugs, tier 1; distances computed）。 核实 2026-09-16 当批。 核实 2026-09-16 当批（同中文侧）。
    identity:
      "Vejle stands at the head of a fjord on the east coast of Jutland, with 62,153 people in the built-up area and 123,947 in the municipality at the start of 2026 (Statistics Denmark) — on that same built-up-area table it is Denmark's ninth largest town. Eight and a half kilometres north-west, at Jelling, stand two Viking-age mounds and two runic stones inscribed as World Heritage in 1994, and north of town the deeply cut Grejsdalen valley was formed in two stretches of different origin (see this library's terrain entry).",
    howItWorks:
      "Danish local government has two tiers: 98 municipalities run schools, elderly care, social services and local roads, the regions run hospitals, and the state runs police and universities. Vejle's council has 31 seats, and the mayor is not elected directly but chosen by the elected councillors at their constituting meeting; the last municipal and regional elections were in November 2025 and the new council took office in January 2026. The municipality reaches far beyond the town: the mounds and runic stones at Jelling are eight and a half kilometres out, yet administratively part of Vejle, and UNESCO's own location note for the site reads \"Vejle Commune, Region of Southern Denmark\". Terrain shapes the town: the fjord reaches in from the east, the built-up area sits in the valley at its head, slopes rise steeply to north and south, and Grejsdalen cuts in from the north — not a common arrangement in a country as flat as Denmark. Newcomers often treat Vejle as a stop on the way to the Lego park at Billund, when the airport is a little over twenty kilometres west and the town is a centre of eastern Jutland in its own right; many also take Jelling for a separate town, when it is a village within the same municipality.",
    layout:
      "The centre is at the head of the fjord, around the church square and the town hall. The Wave apartment blocks stand about 1.5 km east on the north shore of the fjord, the Vejle Fjord Bridge crosses about 3 km south-east, and the wooded slopes of Munkebjerg rise on the south shore about 5 km south-east. Grejsdalen cuts in from the north, its mouth about 2.6 km from the centre in a straight line, and the Jelling monuments and the Kongernes Jelling centre are about 8.6 km north-west in a straight line.",
    gettingAround:
      "Vejle has no airport with scheduled flights; the nearest that has them is Billund, about 24 km away in a straight line. Trains do the work, with Vejle on the north–south main line through eastern Jutland and at the junction for the branch to Esbjerg. The centre is walkable, and trains and buses run to Jelling. The climate is temperate maritime, damp and cold in winter and mild in summer.",
    culture:
      "Danish is spoken, and English is widely used. Service is already included in hotel, restaurant and taxi bills; if the service was good you may add something, and how much is entirely up to you — Denmark has no set etiquette for it. Tap water comes almost entirely from groundwater and can be drunk straight from the tap. The supply is 230 V at 50 Hz, with sockets built to Denmark's own national standard, into which the two-round-pin continental plug fits.",
    seeAndDo:
      "The two mounds, two runic stones and church at Jelling, with the Kongernes Jelling centre beside them; the Wave on the fjord; a walk into the steep-sided, wooded Grejsdalen; the woodland paths on Munkebjerg; and the pedestrian streets and fjord promenade in town.",
    whenAndTips:
      "May to September is the most comfortable; the mounds at Jelling stand in open country and catch the wind. The slopes north and south of town are steep for cycling, and the train is easier than driving for the trip to Jelling.",
  },

  stege: {
    // 全七段 sources: 同中文侧（Statistics Denmark BY1 and FOLK1A, tier 1; UNESCO on the 2025 inscription of Møns Klint, tier 1; DarkSky International certification listing, tier 2; VisitDenmark, Danish EPA and Safety Technology Authority, tier 1; distances computed）。 核实 2026-09-16 当批。 核实 2026-09-16 当批（同中文侧）。
    identity:
      "Stege is a small town on the Danish island of Møn, with 3,811 people in the built-up area at the start of 2026 (Statistics Denmark) — on that same table the largest town on the island. Its medieval moat, ramparts and one town gate are still there. At the island's eastern end, the chalk cliffs of Møns Klint were inscribed as World Heritage in July 2025 and are what most visitors come for.",
    howItWorks:
      "Stege has no town government of its own: the 2007 local-government reform merged it into Vordingborg municipality, whose offices are at Vordingborg on the Zealand side rather than on Møn — an old market town with a medieval moat and gate whose town hall is now somewhere else entirely. Danish local government has two tiers: the municipality runs schools, elderly care and local roads, the region runs hospitals and the state the police and universities; the council is elected and the mayor chosen by the councillors. Møn has two road approaches: the Queen Alexandrine Bridge across the sound, about eight kilometres from town, which is also the only one open to cyclists and walkers; and, since 1985, a car-only route in over the Farø bridges and the island of Bogø. The town itself still has the shape of a medieval market town, with the moat and ramparts around the old core, a gate on its eastern side and the church in the middle. Most people come for the cliffs, sixteen kilometres east at the other end of the island, while the island's accommodation, supermarkets and harbour services are in Stege — the town is the base for the cliffs rather than part of them.",
    layout:
      "The centre is around the church and the old streets, with Mølleporten, the surviving medieval gate, a few hundred metres to the east and the moat and ramparts around the old core. Møns Klint and the geocentre beside it are about 16 to 17 km east in a straight line, the Liselund estate lies just north of the cliffs, Elmelunde Church is about 7 km east along the road, and Klintholm Havn about 12 km south-east. The island of Nyord is about 8 km north-west.",
    gettingAround:
      "Stege has no airport with scheduled flights; the nearest with scheduled passenger service is Copenhagen, about 74 km away in a straight line. Access is by road: the bridge is about 8 km from town, with a second, car-only approach over the Farø bridges, and the drive from Copenhagen takes a little over two hours. Buses run on the island but not often, so a car or a bicycle is the practical way to reach the cliffs and the scattered churches and harbours. The climate is temperate maritime, damp and cold in winter, mild in summer, and windy by the sea.",
    culture:
      "Danish is spoken, and English is widely used. Møn and neighbouring Nyord were certified in 2017 by DarkSky International as a dark sky park and dark sky community, and light pollution here is slight. Service is already included in hotel, restaurant and taxi bills; if the service was good you may add something, and how much is entirely up to you. Tap water comes almost entirely from groundwater and can be drunk straight from the tap. The supply is 230 V at 50 Hz, with sockets built to Denmark's own national standard, into which the two-round-pin continental plug fits.",
    seeAndDo:
      "Møns Klint and the geocentre at the cliffs; Mølleporten, the moat and the ramparts in town; Stege Church; the Liselund estate and its landscape garden behind the cliffs; Elmelunde Church; Klintholm Havn; and the night sky on a clear, moonless night.",
    whenAndTips:
      "May to September is the most comfortable; reaching the beach below the cliffs means a long wooden stairway, and the cliff face is actively eroding, so follow the signs and keep away from the edge. Island buses are infrequent, so driving or hiring a bicycle makes things easier.",
  },
};
