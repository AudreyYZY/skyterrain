...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  "esch-sur-alzette": {
    identity:
      "Esch-sur-Alzette is Luxembourg's second-largest city by population, with a population of about 36,000, at the heart of the Minett industrial region on the Alzette, which grew up from the 19th century around iron-ore mining and the steel industry.",
