...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  "luxembourg-overview": {
    ...
    gettingAround:
      "Luxembourg Findel Airport is the country's only airport, so there are no scheduled domestic flights; the rail and bus network is dense, and since 2020 public transport has been free for all passengers nationwide — the first country in Europe to make its entire public-transport network free. Driving is on the right; the country is small, and intercity journeys are usually under an hour. The climate is temperate maritime, mild and rainy year-round. By law menu prices include service and no cover charge may be added for eating in, so tipping is not required. Tap water is safe to drink. The voltage is 230V with EU-style two-round-pin plugs.",
    culture:
      "Luxembourgish, French and German are all official languages, with French commonly used in business and government documents and English proficiency also high. Close to half of Luxembourg's population are foreign residents, making it one of the most culturally diverse countries in Europe. By law menu prices include service and no cover charge may be added for eating in, so tipping is not required. Tap water is safe to drink.",
    seeAndDo:
  ...
  "luxembourg-city": {
    ...
    culture:
      "Luxembourgish, French and German are all official languages, and English proficiency is also high. As an international financial centre, the city has a high share of foreign residents and a diverse, international atmosphere. By law menu prices include service and no cover charge may be added for eating in, so tipping is not required. Tap water is safe to drink.",
    seeAndDo:
  ...
  "mondorf-les-bains": {
    // 全七段 sources: 同中文侧（STATEC SDMX LU1,DF_X021,1.1, tier 1; elections.public.lu, tier 1; tresorerie.public.lu on the thermal centre, tier 1; thermal centre operator, tier 1; INPA on the parish church, tier 1; mobiliteit.lu bus 413, tier 1; distances computed）。 核实 2026-09-16 当批（content-verifier 独立检索，本条全部 ok）。
    identity:
      "Mondorf-les-Bains is a spa town in the canton of Remich in south-eastern Luxembourg, right on the border, with a municipal population of about 5,500 on 1 January 2026 (STATEC). Its thermal and health centre grew out of a spring found in the mid-19th century and is a public body wholly owned by the state; the town also has the Baroque Church of St Michael, completed in 1766.",
    howItWorks:
      "Mondorf-les-Bains is a commune with an elected council, and its mayor is appointed by the Grand Duke from among the councillors on the nomination of a majority of them; Luxembourg has only communes and the state, with no provinces in between. The town's main institution, the thermal and health centre, does not belong to the commune: it is a public body set up under a 1987 law, 100% owned by the state and overseen by the Ministry of Health and Social Security, and the commune has a single seat on its board. The central square, the church, the spa park and the thermal centre are all within a few hundred metres of one another, and the commune also covers two small villages. Locals find their way by the spa, the church and the square. Daily life reaches across the border and towards the capital: Luxembourg City is about 16 km away in a straight line, regional buses carry commuters and public transport is free nationwide, while a village with an almost identical name just across the border belongs to the neighbouring country. Newcomers often imagine 'les-Bains' means a large spa city, when the whole commune has about 5,500 people and the spa is a single institution, and they also confuse it with the village of the same name on the other side of the border.",
    layout:
      "Shops and bus stops cluster around the central square, St Michael's Church stands west of the square, and the spa park and thermal centre lie in the south-east of town. Around the town are the fields and vineyards of the Gutland, with Remich in the Moselle valley a short way east.",
    gettingAround:
      "Luxembourg Findel Airport (LUX) is about 14 km away in a straight line. There is no railway station; RGTR regional bus 413 links Luxembourg railway station, Mondorf and Remich, and public transport is free nationwide. The town is walkable.",
    culture:
      "Luxembourgish, French and German are used side by side, and English is common in services. The thermal centre's facilities have been renovated in phases since 2023, and as of September 2026 the work is still under way, so check the operator's notices for which areas are open. By law menu prices include service and no cover charge may be added for eating in, so tipping is not required. Tap water is safe to drink.",
    seeAndDo:
      "The thermal centre's pools and the spa park; St Michael's Church, completed in 1766, with its trompe-l'oeil apse; a stroll around the central square; and a trip east to Remich and the vineyards of the Moselle valley.",
    whenAndTips:
      "Worth a visit all year, since the indoor thermal facilities are unaffected by the seasons; May–September suits walks in the park and vineyards. During the renovation, check the operator's announcements for open areas and hours.",
  },

  differdange: {
    // 全七段 sources: 同中文侧（STATEC at 1 January 2026, tier 1; differdange.lu for the 19-seat council and the four localities, tier 1; elections.public.lu on how mayors are appointed, tier 1; environnement.public.lu on the Prënzebierg–Giele Botter reserve, tier 1; company site on the steelworks, tier 1 self-description; UNESCO MAB Minett, tier 1–2）。 核实 2026-09-16 当批。 核实 2026-09-16 当批（同中文侧）。
    identity:
      "Differdange (Déifferdeng in Luxembourgish) lies in the Minett industrial district of southern Luxembourg, with 31,421 residents in the commune in January 2026 (STATEC) — on that same table the third most populous commune in the country. Its steelworks still roll extra-large H-sections, while more than six tenths of the commune's area is woodland, farmland and nature reserve.",
    howItWorks:
      "Luxembourg has only communes and the state, with no provincial layer in between. Differdange's council has 19 seats — the statutory number for communes of 20,000 or more, including the mayor and four aldermen; its meetings are public, it can call a referendum, and the mayor is nominated from among the elected councillors and appointed by the Grand Duke for six years. The commune is not one town but four parts: Differdange-Fousbann, the main town, with about 17,900 people; Niederkorn with about 8,200; Oberkorn with about 4,800; and Lasauvage at the western end with 457, with three railway stations spread among them. Of the commune's twenty-two-odd square kilometres, the built-up area is under four tenths and the rest is woodland, farmland and protected land — unusual for an industrial town: the reserve shared with the neighbouring commune to the north-west was an open-cast iron mine, protected since 1991 and set within a European habitat site of over a thousand hectares. Newcomers get two things wrong: that steelmaking in the south has stopped, when the furnace and mills here are still running; and that the castle on the rise is the town hall, when it houses a university's European campus.",
    layout:
      "The centre is in the main town, with the Aalt Stadhaus cultural centre and the Luxembourg Science Center both there and the castle a few hundred metres west of the cultural centre. Niederkorn is about 1.4 km north of the centre, Lasauvage about 4 km west, and the steelworks to the north-east. Fond-de-Gras, with its industrial heritage and tourist railway, is about 2.7 km north-west in the neighbouring commune.",
    gettingAround:
      "Luxembourg Findel Airport is about 25 km north-east in a straight line and is the country's only airport with scheduled passenger flights. Public transport throughout Luxembourg is free, the commune has three railway stations, and trains run to the capital and to Esch. Buses and walking do the rest. The climate is temperate maritime, damp and cold in winter.",
    culture:
      "Luxembourgish is the national language, with French and German also official, and place names often come in two forms (Differdange / Déifferdeng). The town has a science centre and a cultural centre, and the castle is a university campus. By law menu prices include service and no cover charge may be added for eating in, so tipping is not required. Tap water is safe to drink. The supply is 230 V at 50 Hz with type F sockets, into which the two-round-pin continental plug fits.",
    seeAndDo:
      "The hands-on exhibits and science shows at the Luxembourg Science Center; the Aalt Stadhaus cultural centre; the castle and its campus grounds; the nature reserve shared with the neighbouring commune, where an old iron pit has become habitat and walking trails; and the old mining village of Lasauvage at the western end.",
    whenAndTips:
      "April to October suits the trails in the reserve. The town hall is being renovated and its counters are temporarily split across several addresses, so check the commune's notices if you need one. The reserve is old mine ground, so keep to the marked paths.",
  },

  mersch: {
    // 全七段 sources: 同中文侧（STATEC at 1 January 2026, tier 1; mersch.lu on the 15-seat council, the castles and the geographical centre, tier 1; visitluxembourg on the town hall in the castle and the three rivers, tier 1; elections.public.lu, tier 1; distances computed）。 核实 2026-09-16 当批。 核实 2026-09-16 当批（同中文侧）。
    identity:
      "Mersch (Miersch in Luxembourgish) lies in central Luxembourg, with 10,888 residents in the commune in January 2026 (STATEC), built where the Alzette meets the Mamer and the Eisch, about 15 km north of the capital. The medieval castle in the middle of town is now the town hall, and according to the commune's own website the geographical centre of the country lies within one of its nature reserves.",
    howItWorks:
      "Luxembourg has only communes and the state. Mersch's council has 15 seats, with a college of one mayor and three aldermen; the mayor is nominated from among the elected councillors and appointed by the Grand Duke for six years. The most telling fact here is that the town hall is inside the castle — the medieval castle is an office building rather than a sight, with a museum alongside. The commune is the town plus several surrounding villages, and by the commune's own account only about a third of its residents live in the town itself. People often speak of the \"canton of Mersch\", but in Luxembourg a canton is only a statistical and judicial division rather than a tier of government: the canton has over 37,000 people, the commune just over ten thousand. The Eisch valley, known for its seven castles, lies to the west, but those castles are spread across several communes — Schoenfels and Pettingen are in this one, while Hollenfels and Ansembourg are in the neighbouring commune. A main railway line runs through the town, tying the capital to the north, and public transport across the country is free.",
    layout:
      "The centre is around the castle, now the town hall, and the Tour Saint-Michel, with the national literature centre a few hundred metres north-east and the station about 0.67 km north-east. Schoenfels Castle is about 3.2 km south in a straight line, Hollenfels Castle about 5.4 km west in the neighbouring commune, and Ansembourg, the anchor of the Eisch valley, about 7 km west.",
    gettingAround:
      "Luxembourg Findel Airport is about 16 km south-east in a straight line and is the country's only airport with scheduled passenger flights. Trains run from the town to the capital and to the northern towns, and public transport across the country is free. The town is walkable, while the castles and reserves are best reached by car or bicycle. The climate is temperate maritime, damp and cold in winter.",
    culture:
      "Luxembourgish is the national language, with French and German also official, and the town's name comes in both forms (Mersch / Miersch). The national literature centre is here, along with a fire-service museum opened in 2024. By law menu prices include service and no cover charge may be added for eating in, so tipping is not required. Tap water is safe to drink. The supply is 230 V at 50 Hz with type F sockets, into which the two-round-pin continental plug fits.",
    seeAndDo:
      "The castle and the Tour Saint-Michel; the national literature centre; Schoenfels Castle to the south; Hollenfels Castle and Ansembourg in the neighbouring commune, with a walk along the Eisch valley; the moated castle at Pettingen; and the country's geographical centre in the Pëttenerbësch reserve.",
    whenAndTips:
      "April to October suits walking along the valley; the castle is an office building, so what you see is mostly the exterior and the museum. The castles are spread across different communes, so allow for driving time when planning a day.",
  },
};
