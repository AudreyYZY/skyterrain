...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "esch-sur-alzette": {
    ...
    gettingAround:
      "本地无商业机场，最近机场为卢森堡芬德尔机场（直线约22公里）；公共交通全境免费，市内有巴士网络（卢森堡市至埃施的快速轻轨规划于2030年代分段通车）。属温带海洋性气候。",
    culture:
  ...
  echternach: {
    ...
    gettingAround:
      "本地无商业机场，最近机场为卢森堡芬德尔机场（直线约26公里）；公共交通全境免费。老城步行可达，前往米勒达尔徒步区需自驾或乘公交。属温带海洋性气候。",
    culture:
  ...
  remich: {
    ...
    gettingAround:
      "本地无商业机场，最近机场为卢森堡芬德尔机场（直线约15公里）；公共交通全境免费。小镇步行可达，探索沿河葡萄园需自驾或骑行。属温带海洋性气候，是卢森堡气候最温和的地区。",
    culture:
  ...
  diekirch: {
    ...
    gettingAround:
      "本地无商业机场，最近机场为卢森堡芬德尔机场（直线约27公里）；公共交通全境免费。老城步行可达。属温带海洋性气候。",
    culture:
  ...
  ettelbruck: {
    ...
    gettingAround:
      "本地无商业机场，最近机场为卢森堡芬德尔机场（直线约26公里）；公共交通全境免费，火车站是北部地区重要的换乘枢纽。属温带海洋性气候。",
    culture:
  ...
  clervaux: {
    ...
    gettingAround:
      "本地无商业机场，最近机场为卢森堡芬德尔机场（直线约50公里）；公共交通全境免费。小镇步行可达。属温带海洋性气候。",
    culture:
  ...
  "esch-sur-sure": {
    ...
    howItWorks:
      "埃施叙尔苏尔是卢森堡西北维尔茨县的市镇，2011 年与诺伊豪森、海德沙伊德合并后人口约 3,280，市域约 51 平方公里，由选举产生的市议会治理、市长由大公从议员中任命；卢森堡只有市镇与国家两级，中间没有省。镇子本身只有约 415 人，地形是它的全部说明：苏尔河在这里绕了一个近乎闭合的急弯，把一块岩脊几乎围成孤岛，房子挤在这块岩脊上，进镇要穿过一条开在山体里的隧道，10 世纪的城堡废墟压在最高处。1960 年代国家在上游筑坝，形成了长约十公里的上苏尔湖——这座水库是卢森堡全国最主要的饮用水源，因此湖区的活动受管理，围绕它设立了上苏尔自然公园。卢森堡市在东南直线约 37 公里。初来的人最容易犯的错，是把水库当作普通的游泳湖，而它是全国的水源地，哪些水面可以下水由规定说了算。",
    layout:
      "小镇建在苏尔河一处近乎闭合的河曲半岛上，城堡遗址俯瞰整个老城与河曲，上苏尔湖水库紧邻小镇西侧。",
    gettingAround:
      "本地无商业机场，最近机场为卢森堡芬德尔机场（直线约39公里）；公共交通全境免费，湖区探索建议自驾或骑行。属温带海洋性气候。",
    culture:
