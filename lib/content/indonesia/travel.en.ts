...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  balikpapan: {
    ...
    identity:
      "Balikpapan is East Kalimantan's oil-industry city, with a registered population of about 770,000 in the first half of 2026 (Balikpapan City Civil Registry); it is one of Indonesia's most important economic centres on Borneo and the main air gateway to Nusantara, the country's new capital under construction.",
  ...
  palembang: {
    // 全七段 sources: 同中文侧（BPS SIMDASI table 3.1.1 republished on the South Sumatra open-data portal, resource uploaded 2025 — the exact reference date is unconfirmed, so the text says "2025 basis"; no same-table digit check against another repo city is possible because Indonesian tables are issued province by province, and that gap is recorded rather than papered over; internal consistency checks do pass. City government site for the 18 districts, tier 1; the airport's international status was revoked in 2024 and restored in 2025, tier 2, so the text carries the years only; distances computed from this entry's own coordinates）。 核实 2026-09-17 当批。
    identity:
      "Palembang lies on the lower Musi in south-eastern Sumatra, with about 1.72 million people on the 2025 basis (Statistics Indonesia), the capital of South Sumatra and one of the island's largest cities. The river runs through the middle with the Ampera Bridge joining the banks; the city grew on that river, and its port, markets and old quarters still line it.",
    howItWorks:
      "The way people give an address here is really the direction of a river. The Musi divides the city in two: the northern bank is Ilir, downstream, and the southern bank is Ulu, upstream. The districts are named for exactly that, with numbers — East Ilir One, Two and Three, Seberang Ulu One and Two — and the neighbourhoods below them are simply \"16 Ilir\" or \"7 Ulu\", a number plus the direction of the water; \"16 Ilir\" is both a place name and the name of the old market. People give that number first, then the street and house, with two further levels of RT and RW below the street. The commonest mistake newcomers make is taking Ilir and Ulu for two district names, when they are the directions of the river. The city has eighteen districts, and the provincial government sits inside it — province and city being two separate administrations. The river also sets the living radius: crossing means a bridge, and each bank has its own markets and landings.",
    layout:
      "The centre is around the mayor's office. Kuto Besak Fort is about 0.3 km east-south-east on the riverbank, the Sultan Mahmud Badaruddin II Museum about 0.5 km due east, the Ampera Bridge about 0.8 km due east, and the Kampung Kapitan quarter about 0.9 km east-south-east on the southern bank. Bukit Siguntang park is about 3.5 km west-south-west and Jakabaring Sport City about 5 km south-east.",
    gettingAround:
      "Sultan Mahmud Badaruddin II Airport is about 12 km north-north-west in a straight line and lies within the city itself, with domestic and international scheduled flights — its international status was revoked in 2024 and restored in 2025. A light rail line links the airport with the city, so you can take rail straight in on landing; buses and river boats cover the rest. The climate is equatorial, hot and wet all year.",
    culture:
      "Indonesian is spoken, along with the local Palembang Malay. Fishcake made from river fish is the city's signature dish, and the old markets along the water are the centre of daily life. Whether a service charge is included is what the bill says; register your stay as required after arrival.",
    seeAndDo:
      "Crossing the Ampera Bridge for the view of both banks; Kuto Besak Fort and the sultan's museum on the waterfront; the old riverside houses of Kampung Kapitan on the southern bank; the climb up Bukit Siguntang; and the Jakabaring sports area to the south-east.",
    whenAndTips:
      "May to September is the drier stretch. The city straddles the river with a centre on each bank, so check which side you are heading for; small boats are part of local transport, and it is worth agreeing the fare and route before boarding.",
  },

  banjarmasin: {
    // 全七段 sources: 同中文侧（city civil-registry office's half-year population aggregate, source data from the interior ministry's registration system, tier 1 — under the 2013 law these are published twice a year with reference dates of 30 June and 31 December, so this figure is at 30 June 2026; the five district figures sum exactly to the total; no same-table check against another repo city is possible because these booklets are issued city by city, and that gap is recorded. Provincial portal for the 1956–2022 capital years and the area, tier 1; the city's 500th anniversary on 24 September 2026, tier 1; distances computed from this entry's own coordinates）。 核实 2026-09-17 当批。
    identity:
      "Banjarmasin sits on the delta between the Martapura and Barito rivers in southern Kalimantan, with 685,462 registered residents at 30 June 2026 (city civil registry) over about 98 km². Channels cut the built-up area into some twenty-five separate pieces, bridges and waterways are everywhere, and the city calls itself the city of a thousand rivers.",
    howItWorks:
      "The thing most people get wrong about this city is that it is no longer the provincial capital. It was the capital of Kalimantan province, then of South Kalimantan from 1956 — but a 2022 law moved the seat to Banjarbaru to the south-east, where the governor's office and the provincial agencies now are, and where the airport is too. Banjarmasin is still the largest and busiest city in the province, but provincial business now means leaving town. The city has five districts and fifty-two neighbourhoods; the mayor is directly elected while district and neighbourhood heads are appointed officials, and addresses carry two further levels of RT and RW below the street. Curiously, the neighbourhood the city hall stands in holds only about 2,800 people and its neighbour fewer still — almost nobody lives in the office-and-commerce core, and the largest neighbourhoods are in the north. The neighbourhood names here also use Ilir and Ulu, downstream and upstream, to tell apart places that share a name — the same river logic as Palembang, written in the same batch: in both cities, direction follows the water.",
    layout:
      "The city hall is in the middle of town. The Bekantan statue is about 0.9 km north-east on the waterfront, the Siring riverside market and viewing tower about 1.1 to 1.3 km north-north-east, and Kampung Hijau about 2.5 km east-north-east. The Sultan Suriansyah Mosque is about 4 km north-north-west and Pulau Kembang about 3.9 km north-west on the river. The Lok Baintan floating market is about 12 km east-north-east, in the neighbouring regency of Banjar.",
    gettingAround:
      "Syamsudin Noor International Airport is about 23 km east-south-east in a straight line, with scheduled flights — it is in the city of Banjarbaru rather than in Banjarmasin, which is the same thread as the provincial capital having moved there. Buses and motorcycle taxis cover the city, and boats on the channels are part of local transport too. The climate is equatorial, hot and wet all year.",
    culture:
      "Indonesian and Banjarese are spoken. Life here follows the water: the early-morning floating markets, the riverside stalls and the landings are all part of the ordinary day. 24 September 2026 is the city's five-hundredth anniversary. Whether a service charge is included is what the bill says; register your stay as required after arrival.",
    seeAndDo:
      "The floating markets at first light — one on the city waterfront and a larger one twelve kilometres north-east in the neighbouring regency; the viewing tower and the Bekantan statue by the river; the timber architecture of the Sultan Suriansyah Mosque; a boat out to Pulau Kembang for the monkeys; and the riverside lanes of Kampung Hijau.",
    whenAndTips:
      "May to September is the drier stretch. The floating markets open around first light and shift with the tide, so start early and ask the day before about departure times; with waterways everywhere, hiring a boat for a river trip is the usual way to see the place — agree the price and route before you board.",
  },
};
