...
export const POIS: Record<string, CityPoi[]> = {
  ...
  kaili: [
    ...
    { nameZh: "镇远古城", nameEn: "Zhenyuan Old Town", lon: 108.4279, lat: 27.0508, kind: "district" },
  ...
  wuzhen: [
    { nameZh: "西栅景区", nameEn: "Xizha Scenic Area", lon: 120.4789, lat: 30.7568, kind: "district" },
    { nameZh: "东栅景区", nameEn: "Dongzha Scenic Area", lon: 120.4917, lat: 30.7420, kind: "district" },
    { nameZh: "茅盾故居", nameEn: "Mao Dun's Former Residence", lon: 120.4896, lat: 30.7407, kind: "landmark" },
    { nameZh: "木心美术馆", nameEn: "Mu Xin Art Museum", lon: 120.4834, lat: 30.7527, kind: "landmark" },
    { nameZh: "乌镇大剧院", nameEn: "Wuzhen Grand Theatre", lon: 120.4847, lat: 30.7521, kind: "landmark" },
  ],
  zhouzhuang: [
    { nameZh: "双桥", nameEn: "Twin Bridges", lon: 120.8458, lat: 31.1164, kind: "landmark" },
    { nameZh: "沈厅", nameEn: "Shen Residence", lon: 120.8466, lat: 31.1150, kind: "landmark" },
    { nameZh: "张厅", nameEn: "Zhang Residence", lon: 120.8465, lat: 31.1161, kind: "landmark" },
    { nameZh: "澄虚道院", nameEn: "Chengxu Taoist Temple", lon: 120.8447, lat: 31.1144, kind: "landmark" },
  ],
  yixian: [
    { nameZh: "宏村", nameEn: "Hongcun", lon: 117.9847, lat: 30.0048, kind: "district" },
    { nameZh: "月沼", nameEn: "Moon Pond", lon: 117.9844, lat: 30.0054, kind: "landmark" },
    { nameZh: "南湖", nameEn: "South Lake", lon: 117.9845, lat: 30.0035, kind: "nature" },
    { nameZh: "承志堂", nameEn: "Chengzhi Hall", lon: 117.9839, lat: 30.0065, kind: "landmark" },
    { nameZh: "西递", nameEn: "Xidi", lon: 117.9913, lat: 29.9061, kind: "district" },
    { nameZh: "黟县东站", nameEn: "Yixian East Railway Station", lon: 118.0428, lat: 29.8883, kind: "transport" },
  ],
  yangshuo: [
    { nameZh: "西街", nameEn: "West Street", lon: 110.4897, lat: 24.7782, kind: "district" },
    { nameZh: "遇龙河", nameEn: "Yulong River", lon: 110.5064, lat: 24.7699, kind: "nature" },
    { nameZh: "十里画廊", nameEn: "Ten-Mile Gallery", lon: 110.4861, lat: 24.7370, kind: "nature" },
    { nameZh: "碧莲峰", nameEn: "Bilian Peak", lon: 110.4923, lat: 24.7775, kind: "nature" },
    { nameZh: "兴坪镇", nameEn: "Xingping Town", lon: 110.5281, lat: 24.9199, kind: "district" },
    { nameZh: "阳朔站", nameEn: "Yangshuo Railway Station", lon: 110.5634, lat: 24.9636, kind: "transport" },
  ],
  zhenyuan: [
    { nameZh: "镇远古城", nameEn: "Zhenyuan Old Town", lon: 108.4279, lat: 27.0508, kind: "district" },
    { nameZh: "青龙洞", nameEn: "Qinglong Cave Complex", lon: 108.4286, lat: 27.0530, kind: "landmark" },
    { nameZh: "祝圣桥", nameEn: "Zhusheng Bridge", lon: 108.4278, lat: 27.0539, kind: "landmark" },
    { nameZh: "石屏山", nameEn: "Shiping Hill", lon: 108.4230, lat: 27.0569, kind: "nature" },
    { nameZh: "镇远站", nameEn: "Zhenyuan Railway Station", lon: 108.4074, lat: 27.0402, kind: "transport" },
  ],
  xijiang: [
    { nameZh: "西江千户苗寨", nameEn: "Xijiang Miao Village", lon: 108.1702, lat: 26.4956, kind: "district" },
    { nameZh: "东引观景台", nameEn: "Dongyin Viewing Platform", lon: 108.1731, lat: 26.4962, kind: "landmark" },
    { nameZh: "上郎德村", nameEn: "Shanglangde Village", lon: 108.0569, lat: 26.4744, kind: "district" },
  ],
  jiuzhaigou: [
    { nameZh: "九寨沟沟口", nameEn: "Jiuzhaigou Park Entrance", lon: 103.9177, lat: 33.2681, kind: "transport" },
    { nameZh: "树正群海", nameEn: "Shuzheng Lakes", lon: 103.8996, lat: 33.2043, kind: "nature" },
    { nameZh: "诺日朗瀑布", nameEn: "Nuorilang Waterfall", lon: 103.9051, lat: 33.1655, kind: "nature" },
    { nameZh: "珍珠滩瀑布", nameEn: "Pearl Shoal Waterfall", lon: 103.8850, lat: 33.1686, kind: "nature" },
    { nameZh: "五花海", nameEn: "Five-Flower Lake", lon: 103.8784, lat: 33.1605, kind: "nature" },
    { nameZh: "长海", nameEn: "Long Lake", lon: 103.9285, lat: 33.0232, kind: "nature" },
  ],
  yuanyang: [
    { nameZh: "多依树梯田", nameEn: "Duoyishu Terraces", lon: 102.7947, lat: 23.0919, kind: "nature" },
    { nameZh: "坝达梯田", nameEn: "Bada Terraces", lon: 102.7673, lat: 23.1152, kind: "nature" },
    { nameZh: "老虎嘴梯田", nameEn: "Laohuzui Terraces", lon: 102.7435, lat: 23.0761, kind: "nature" },
    { nameZh: "阿者科", nameEn: "Azheke Village", lon: 102.8199, lat: 23.0907, kind: "district" },
    { nameZh: "哈尼梯田文化博物馆", nameEn: "Hani Terraces Culture Museum", lon: 102.7395, lat: 23.1089, kind: "landmark" },
    { nameZh: "南沙（元阳县城）", nameEn: "Nansha (county seat)", lon: 102.8337, lat: 23.2225, kind: "district" },
  ],
  jianshui: [
    { nameZh: "朝阳楼", nameEn: "Chaoyang Gate Tower", lon: 102.8295, lat: 23.6192, kind: "landmark" },
    { nameZh: "建水文庙", nameEn: "Jianshui Confucian Temple", lon: 102.8198, lat: 23.6181, kind: "landmark" },
    { nameZh: "朱家花园", nameEn: "Zhu Family Garden", lon: 102.8258, lat: 23.6185, kind: "landmark" },
    { nameZh: "临安府署", nameEn: "Lin'an Prefecture Office", lon: 102.8228, lat: 23.6157, kind: "landmark" },
    { nameZh: "双龙桥", nameEn: "Double Dragon Bridge", lon: 102.7928, lat: 23.6083, kind: "landmark" },
    { nameZh: "团山村", nameEn: "Tuanshan Village", lon: 102.7357, lat: 23.6436, kind: "district" },
  ],
  langzhong: [
    { nameZh: "阆中古城", nameEn: "Langzhong Old Town", lon: 105.9651, lat: 31.5774, kind: "district" },
