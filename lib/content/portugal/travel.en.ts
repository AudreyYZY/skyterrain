...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  tavira: {
    ...
    gettingAround:
      "Tavira has no airport with scheduled flights; Faro Airport is about 31 km away. Trains from Faro take about 35 minutes, and buses are easy. The old town is walkable, and hire bicycles suit the river and the salt pans; the ferry to the island runs often in summer and less in winter. The climate is Mediterranean — one of the sunniest corners of Europe.",
    culture:
