...
// 本国惯例（小费）2026-09-16 全库排查：只有旅游站来源，删去比例。见 docs/known-errors.md C10。
...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "mongolia-overview": {
    ...
    culture:
      "官方语言为蒙古语（西里尔字母书写），英语在乌兰巴托及旅游业有一定普及。蒙古人重视游牧传统与待客之道，进入蒙古包（格尔）做客有相应礼俗（如不可脚踩门槛、双手接物）。给小费不是当地的传统，城市餐厅近年渐渐流行，没有统一比例。电压220V，插座多为C/E/F欧标两圆脚。",
    seeAndDo:
  ...
  ulaanbaatar: {
    ...
    culture:
      "官方语言为蒙古语，年均气温约-0.8摄氏度，是全球气候最寒冷的首都之一。城市融合了苏联式建筑、藏传佛教寺院与现代高楼。给小费不是当地的传统，城市餐厅近年渐渐流行，没有统一比例。",
    seeAndDo:
