...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  darkhan: {
    ...
    whenAndTips:
      "6-8月气候最宜人；作为铁路沿线城市，适合作为乌兰巴托与色楞格河北部方向行程的中转停留点。",
  },
  kharkhorin: {
    ...
    howItWorks:
      "哈拉和林是蒙古国前杭爱省的一个苏木中心，2025 年人口约 1.18 万（蒙古国家统计局，哈拉和林苏木常住人口）；蒙古的地方行政分省（艾马格）与苏木两级，省长由总理任命、苏木长由省长任命，人选先要在本级民选的公民代表呼拉尔获得过半数票，教育与医疗按省统筹。镇子在鄂尔浑河下游的谷地，杭爱山脉在这里落到中部草原上。它的分量全在脚下：13 世纪蒙古帝国的都城哈拉和林就在此处，1235 年前后建成，是当时横跨欧亚的这个帝国的政治中心，后来被毁，如今地面上只剩基址与散落的石构件。1585 年建成的额尔德尼召寺就用废墟里的石料砌起，围墙上一百零八座白塔是它的标志，寺院至今在使用。鄂尔浑河谷文化景观 2004 年列入世界遗产，覆盖的正是这一带。旅游与河谷的灌溉农业是本地经济，乌兰巴托在东面约 360 公里。初来的人最容易犯的错，是以为能看到一座都城，而地面上的城早已不存，看的是遗址与寺。",
    layout:
  ...
  moron: {
    ...
    howItWorks:
      "木伦是蒙古国库苏古尔省的省会，2025年常住人口约4.29万（蒙古国家统计局）；蒙古的地方行政分省与苏木两级，省长由总理任命、苏木长由省长任命，人选先要在本级民选的公民代表呼拉尔获得过半数票，省会集中了全省的行政、医疗与中学。城市在德勒格尔木伦河边，海拔约 1,710 米，名字在蒙古语里就是“河”的意思。它从一座寺院长起来：约 1809 至 1811 年间此地建寺，鼎盛时住着约一千三百名僧人，1937 年被毁，1990 年在原址附近重建了丹赞达尔扎寺。省博物馆藏有三千六百多件文物。这座城的现代化来得很晚——2004 年才通电，到乌兰巴托的柏油公路 2014 年 12 月才修通，因此长期以来飞机比公路更管用。库苏古尔湖在北面约 100 公里的哈特嘎勒，省内还有驯鹿放牧的查坦人。冬季最低纪录约零下 47 度。初来的人最容易犯的错，是把木伦当作湖边的镇，而湖在一百公里之外。",
    layout:
      "城市坐落于德勒格尔河谷平地，周边被森林覆盖的山地环绕，与库苏古尔湖之间由公路相连。",
    gettingAround:
      "本地设有木伦机场（MXV），有定期航班；从木伦市区到库苏古尔湖南岸的哈特嘎尔村约需1至1.5小时车程。",
    culture:
  ...
  khovd: {
    ...
    howItWorks:
      "科布多是蒙古国西部科布多省的省会，2025 年常住人口约 3.45 万；蒙古的地方行政分省与苏木两级，省长由总理任命、苏木长由省长任命，人选先要在本级民选的公民代表呼拉尔获得过半数票，省会集中全省的行政、医疗与高等教育，科布多大学在这里。城市在阿尔泰山脉的东麓，布延特河把它分成两半。1685 年准噶尔的噶尔丹博硕克图汗在这一带筑城，后来城址迁到布延特河边的今址；城外保留着清代驻防城的城墙遗迹。这里是蒙古族群最杂的城市之一，哈拉哈、扎哈沁、土尔扈特、乌梁海与哈萨克等十多个族群共居，语言与习俗各不相同。东面约 25 公里是哈日乌斯湖国家公园，是候鸟的重要栖息地。气候属寒漠，冬季最低纪录接近零下 45 度。初来的人最容易犯的错，是以为蒙古西部只有牧民，而这座城是一整个省的行政与大学中心。",
    layout:
      "城市沿穿城而过的河流两岸展开，是蒙古西部历史上多民族（蒙古族、哈萨克族、图瓦人等）聚居与贸易往来的传统中心。",
    gettingAround:
      "本地设有科布多机场（HVD），有定期航班；前往蒙古阿尔泰山塔王博格达等景点需公路自驾或包车，车程约数小时至一整天不等。",
    culture:
  ...
  choibalsan: {
    ...
    howItWorks:
      "乔巴山是蒙古国东部道尔诺德省的省会，2025 年常住人口约 4.68 万，是继乌兰巴托、达尔汗与额尔登特之后蒙古第四大城市；蒙古的地方行政分省与苏木两级，省长由总理任命、苏木长由省长任命，人选先要在本级民选的公民代表呼拉尔获得过半数票。城市在克鲁伦河边，海拔约 747 米，四周是蒙古东部一望无际的草原——这片草原是世界上保存最完整的温带草原之一，蒙原羚成群迁徙的地方就在附近。它原名巴彦图门，1941 年为纪念 1921 年革命二十周年，改用当时领导人霍尔洛·乔巴山的名字。20 世纪它成为铁路节点，城里有一条向北的支线。城郊有纪念格奥尔基·朱可夫的博物馆，因为 1939 年的哈拉哈河战役就发生在这个省。机场有飞往乌兰巴托与中国城市的航班。极端气温从零下 41 度到近 42 度。初来的人最容易犯的错，是以为这里的铁路能一路把人带到更远的地方，实际的客运班次很有限。",
    layout:
      "城市沿克鲁伦河两岸展开，是蒙古东部草原地带最大的城市与区域行政中心。",
    gettingAround:
      "本地设有乔巴山机场（COQ），有定期航班；前往蒙古达乌尔严格保护区等东部草原景点需公路自驾或包车。",
    culture:
  ...
  tsetserleg: {
    ...
    howItWorks:
      "车车尔勒格是蒙古国阿尔汗盖省的省会，2025 年常住人口约 2.14 万，市域约 536 平方公里，海拔约 1,691 米；蒙古的地方行政分省与苏木两级，省长由总理任命、苏木长由省长任命，人选先要在本级民选的公民代表呼拉尔获得过半数票，省会集中全省的医院、剧院与中等教育。城市在杭爱山脉的东北坡上，背靠布尔干山，乌兰巴托在东面直线约 410 公里。城镇围绕扎音格根寺发展起来，20 世纪寺庙停用，主殿如今是阿尔汗盖省博物馆，山坡上的白色佛像与寺墙是全城的背景。地形给了它一个特别之处：虽在高原上，它的冬天比周边缓和，一月夜间约在零下 15 至 25 度，在蒙古已算温和。食品加工是本地的主要工业，另有农牧学院。城外的岑赫尔温泉与更西的白湖是省内的去处，都需数小时车程。初来的人最容易犯的错，是把它与同省另一个叫车车尔勒格的苏木混淆，那是省北部的另一个行政单位。",
    layout:
  ...
  sainshand: {
    // 全七段 sources（2026-09-16 首写，已有城市补充批；研究子代理事实表 scratchpad/mn-se-cities-facts.md §0、§1）：
    //   开工前读 FCDO 蒙古页（2026-08-07，1 级）：无地区级劝阻；两条实质提示是全国性燃油短缺（含航空燃油）与边境地区最多 100 km 内可能需要边防许可 —— 本批选城一并避开边境带，正文不写国界、口岸、跨境行程（CLAUDE.md 蒙古一节的既定做法）。
    //   人口：赛音山达苏木 2025 年常住 28,250、东戈壁省 73,970（蒙古国家统计局 DT_NSO_0300_004V5，1 级；同表木伦 42,921、达尔汗 89,421、额尔登特 103,118 与既有条目逐位自检一致）。
    //   ⚠️ 2026-09-16 当批核实时蒙古统计局站点（1212.mn）后端故障、新前端纯 JS 取不到数，上面四个 2025 年人口数**未能重新独立核到**（量级与趋势都对得上 2022 年普查数），待源站恢复后回查。
//   行政：现行《行政与领土单位及其治理法》（legalinfo.mn 官方英译，1 级）—— 省下分苏木、苏木下分巴格；**省长由总理任命、苏木长由省长任命、巴格长由苏木长任命，任期 4 年**，候选人先由本级公民代表呼拉尔过半数通过；呼拉尔席位按人口分档（东戈壁省 35 席、赛音山达苏木 29 席，按法条分档算）；苏木一级管到「居民饮用与生活水源点的选址与保护」（第 22 条）。
    //     ⚠️ 既有蒙古条目写的「省长由总理任命、苏木长由省长任命，人选先要在本级民选的公民代表呼拉尔获得过半数票」方向对但不精确，下一轮统一对齐。赛音山达在这部法里是「苏木中心」、是否另有「市」的法定地位未核（unknown），正文只写「省会所在的苏木」。
    //   交通：本地机场 scheduled_service=no、无 IATA 码，正文写「没有定期客运航班」（规则 ⑬）；火车站在城区北片、离城中心 3.0 km（算），只写「有开往乌兰巴托方向的列车」，不写终点与口岸；到乌兰巴托直线约 418 km（算）；FCDO 的「首都以外只有约 10% 的道路铺装」（1 级）。
    //   地标：哈马林寺（乌尔占特格奇楞寺）在城南约 34 km（算），由丹赞拉布扎 1820 年创建（3 级）；丹赞拉布扎（1803–1856）是僧人、诗人、剧作家与医者（3 级）。⚠️ 寺旁的「能量中心」是旅游业与信众的说法，正文只写「一处朝圣地点」不作评价；OSM 在博物馆一带有两个无名节点，分不清馆别，POI 用同一组概略坐标并写明。
    //   礼俗：进佛寺先征得同意再拍照、不触碰圣像与法器；护照随身、警察查验不接受复印件；拍摄警察与军人属违法（FCDO，1 级）。小费沿用本国既有写法（2026-09-16 全库排查后已删去比例）。
    //   不写：国界与边防许可、口岸、跨境列车、城西的废弃军事设施、「世界能量中心」当事实、宗教效果、矿业与油气评价、20 世纪政治、航点列表、没有口径的名次。 核实 2026-09-16 当批。 核实 2026-09-16 当批（content-verifier 独立检索：法条分档与治理链条逐字对上；人口因统计局站点故障未能重核，记 unknown）。
    identity:
      "赛音山达是蒙古东戈壁省的省会，2025年常住人口28,250（蒙古国家统计局），在戈壁的旱草原上。城市沿纵贯蒙古的铁路干线生长，火车站在城区北片；城南三十多公里的戈壁上有哈马林寺，19世纪的僧人、诗人丹赞拉布扎在那里建寺，城里也有以他命名的博物馆。",
    howItWorks:
      "蒙古的地方只有两级：省与苏木（首都则是市与区）。按现行的行政与领土单位及其治理法，省长由总理任命、苏木长由省长任命、巴格长再由苏木长任命，任期四年，人选先要在本级民选的公民代表呼拉尔里获得过半数票；呼拉尔的席位按人口分档，东戈壁省这一档是35席，赛音山达苏木是29席。赛音山达在这部法律里是省会所在的苏木，不是一级“市”。苏木管的事很具体——本级规划与预算、住房与公用事业、本地道路与绿地、垃圾场与墓地，还包括居民饮用与生活水源点的选址和保护，在戈壁，最后这一条比在别处都重。城市的节奏是铁路的节奏：客运和货运走同一条干线，火车站在城区北片、离中心三公里。初来的人常以为要坐飞机来，本地机场其实没有定期客运航班，真正的进出方式是火车；也常以为哈马林寺在城里，它在城外三十多公里的戈壁上。",
    layout:
      "城区沿铁路南北铺开：火车站在城中心以北约3公里，丹赞拉布扎博物馆与省博物馆都在中心一带。哈马林寺与旁边的朝圣地点在城南直线约32到34公里的戈壁上，要开车前往。",
    gettingAround:
      "赛音山达没有定期客运航班的机场；进出主要靠铁路，车站有开往乌兰巴托方向的列车，公路到乌兰巴托直线约418公里。据英国外交部的旅行建议，蒙古首都以外只有约一成道路铺装、路标很少，自驾要有准备；截至2026年9月还有全国性的燃油短缺提示。城区不大，步行或打车即可。属干旱的大陆性气候，冬季严寒、夏季炎热，风沙多。",
    culture:
      "当地说蒙古语，文字用西里尔字母。进入寺院先征得同意再拍照，不要触碰圣像与法器。护照要随身携带——警察查验时不接受复印件；拍摄警察与军人在蒙古属违法。给小费不是当地的传统，城市餐厅近年渐渐流行，没有统一比例。",
    seeAndDo:
      "哈马林寺与寺旁的朝圣地点；丹赞拉布扎博物馆与省博物馆；火车站一带看纵贯线上的货运列车；城外的戈壁景观。",
    whenAndTips:
      "5月到9月最适合出行，7、8月白天很热；冬季严寒。出城看寺要包车或跟当地车，路多为土路，出发前问清路况与返程时间。",
  },

  bayankhongor: {
    // 全七段 sources（2026-09-16 首写，已有城市补充批；研究子代理事实表 scratchpad/mn-se-cities-facts.md §0、§2）：
    //   人口：巴彦洪戈尔苏木 2025 年常住 33,506、巴彦洪戈尔省 87,974（蒙古国家统计局 004V5，1 级）；省会占全省 38.1%（算，正文写「近四成」并写明口径）。⚠️ 英文维基 infobox 的 33,147（2026）不同源不同年，不用。
    //   行政：同 sainshand 的法条（1 级）；省呼拉尔 35 席、苏木呼拉尔 29 席（按法条分档算）。苏木下 10 个巴格（3 级，名单未回一手，正文不列）。
    //   ⚠️ 「1961 年因冻土问题整体搬迁、约 900 户 3,500 多人迁到现址」只有 3 级来源（英文维基），正文按「据…记载」写并留待回一手；省 1941 年设立（3 级）。
    //   交通：BYN 机场在城区约 3.5 km，OurAirports 标有定期航班，但四个来源对国内航线互相矛盾、MIAT 官网取不到，加上 FCDO 的航空燃油短缺提示 —— 不填 airport，正文写「班次很少、出发前查询」，不列航点（规则 ⑫）。无铁路。到乌兰巴托直线约 507 km（算）。
    //   地标：省历史与民族志博物馆、自然史博物馆、剧院（OSM 带 name:en，3 级）；夏尔嘎勒朱特温泉离城约 42 km、奥罗格湖约 125 km（算）。⚠️ 湖泊面积会过期（规则 ⑦），不写面积；图音河两岸的说法未定，正文只写「城在图音河边」不写岸别。
    //   不写：国界与边境、矿业对河流水量的因果论断、湖河面积与水量、免签天数、政治、航点列表、「一个省跨齐所有地貌带」一类旅游话术。 核实 2026-09-16 当批。 核实 2026-09-16 当批（同上；「1961 年搬迁」仍只有百科类来源，正文保留「据记载」）。
    identity:
      "巴彦洪戈尔是蒙古巴彦洪戈尔省的省会，2025年常住人口33,506（蒙古国家统计局），在图音河边、海拔约1,870米。全省87,974人里有近四成住在这座城里（按同一口径算）。省境自北向南从杭爱山脉的南坡经戈壁阿尔泰落到戈壁，城正好在这条纵剖面的中段。",
    howItWorks:
      "蒙古的地方只有省与苏木两级：省长由总理任命、苏木长由省长任命，人选先要在本级民选的公民代表呼拉尔里获得过半数票，任期四年；按人口分档，这个省的呼拉尔是35席、苏木是29席。省会集中了全省的行政、医院与中学，所以近四成的省民住在这里，其余分散在各个苏木；苏木一级管本级预算、住房与公用事业、本地道路，也管居民饮用水源点的选址与保护。据记载，省会并不在最初的位置上——1961年因冻土问题放弃原址，约900户、三千多人整体迁到今天这里（这条只有百科类来源，尚待一手确认）。生活半径由公路决定：这里没有铁路，到乌兰巴托直线就有五百公里，本地机场的航班很少。初来的人常把它当成去戈壁路上的加油点，它其实是这个省唯一集中了行政与医疗的地方。",
    layout:
      "城区沿图音河展开，省历史与民族志博物馆、自然史博物馆与剧院都在市中心几百米内。夏尔嘎勒朱特温泉在城东北直线约42公里，奥罗格湖在城南直线约125公里。",
    gettingAround:
      "本地有巴彦洪戈尔机场，但航班很少、班期不稳定，出发前要查询；进出主要靠公路，到乌兰巴托直线约507公里，省内没有铁路。据英国外交部的旅行建议，蒙古首都以外只有约一成道路铺装、路标很少；截至2026年9月还有全国性的燃油短缺提示，长途出行要把加油点算进计划。城区步行即可。属大陆性高原气候，冬季严寒、昼夜温差大。",
    culture:
      "当地说蒙古语，文字用西里尔字母。进入寺院先征得同意再拍照，不要触碰圣像与法器。护照要随身携带，警察查验时不接受复印件；拍摄警察与军人在蒙古属违法。给小费不是当地的传统，城市餐厅近年渐渐流行，没有统一比例。",
    seeAndDo:
      "省历史与民族志博物馆；自然史博物馆；夏尔嘎勒朱特温泉泡汤；往南去奥罗格湖与戈壁阿尔泰的山前地带；在城里的市场买羊毛与皮具。",
    whenAndTips:
      "6月到9月最适合出行，此时草场绿、道路好走；冬季严寒，长途路段可能封。出城的路多为土路，包车比自驾稳妥，出发前问清加油与返程安排。",
  },
};
