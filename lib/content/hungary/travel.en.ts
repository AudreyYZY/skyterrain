...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  "hungary-overview": {
    identity:
      "Hungary lies in the Carpathian Basin in the middle of Europe and is landlocked. Three things make it easy to place: more than seventy per cent of the country is plain below 200 m, the Danube divides it into an eastern and a western half, and its language is unrelated to those around it — Hungarian belongs to the Uralic family, with no kinship to German, the Slavic languages or Romanian.",
    howItWorks:
      "Hungary is a unitary republic, divided administratively into counties (megye) plus the capital, Budapest, with municipalities (település) below them. It is a member of the EU and of the Schengen area, and its currency is the forint (HUF) rather than the euro, so crossing to neighbouring countries involves no passport check but does involve changing money. Visa requirements vary by nationality and are as most recently published by the Hungarian embassy or consulate in your country; confirm before travelling and allow time.",
    layout:
      "The country is easy to hold in mind through its landforms: the Danube enters from the north-west, crosses the Little Plain, turns south at the Danube Bend and runs the length of the Great Plain before leaving. East of the river is the Great Plain, more than half the country; west of it is Transdanubia, with more relief and Lake Balaton in the middle of it; along the northern edge runs a chain of middle mountains, among them the Mátra with Kékes, the highest point in the country at 1,014 m.",
    gettingAround:
      "Budapest is the national rail and road hub, the lines radiating from it, and travel between cities by train or coach is straightforward; the country is small enough that most county seats are within three hours of the capital. Almost all international flights land at Budapest's Ferenc Liszt airport, with a few European routes into Debrecen. Passenger boats run on the Danube in season.",
    culture:
      "Hungarian is universal; younger people and those in tourism generally have good English. Paprika is the mark of the cooking, with stews such as gulyás and pörkölt and river fish soup among the everyday dishes; wine regions are spread widely, the sweet wines of Tokaj and the reds of Eger each with their own tradition. Thermal baths are part of ordinary life rather than a tourist item. Tipping in restaurants is usually about ten per cent; check whether service is already on the bill.",
    seeAndDo:
      "Budapest (Castle Hill, both banks of the Danube, the thermal baths); Lake Balaton and the basalt witness hills on its northern shore; the Danube Bend (Visegrád, Esztergom, Szentendre); the northern ranges (Eger, the Bükk, the caves of Aggtelek); the Great Plain and the Hortobágy in the east; Pécs in the south and the vineyards of Tokaj.",
    whenAndTips:
  ...
  budapest: {
    ...
    culture:
      "Hungarian is universal, with English usable in the centre and in tourism. Thermal baths are part of the city's daily life — Széchenyi, Gellért and the rest are as much local as visitor places, and each has its own rules about showering first and about caps and swimwear. The café tradition dates from the late nineteenth century and a few of the old houses survive much as they were. Tipping in restaurants is usually about ten per cent; check whether service is already included.",
    seeAndDo:
      "Castle Hill (the old palace, the Matthias Church, the view across from the Fisherman's Bastion); the Parliament and both embankments; Andrássy Avenue and Heroes' Square; the Széchenyi or Gellért baths; the Central Market Hall; Margaret Island; the old buildings and small shops of the Jewish quarter; a boat out to see the lit embankments at night.",
    whenAndTips:
      "April–June and September–October are the most comfortable; July and August are hot, though the embankments and open-air places come into their own in the evening. The Christmas markets make the centre lively in December, and coldest. Castle Hill and Gellért Hill are steep — keep something in reserve for the climbs.",
  },
  debrecen: {
    identity:
    ...
    layout:
      "The city's spine is an avenue running dead straight from the railway station to the Great Church, the square in front of which is the centre. The avenue continues north and ends at the Great Forest, a stretch of woodland park on the city's edge holding the thermal baths, the zoo and the university's main campus. The rest is flat residential fabric with no relief to speak of.",
    gettingAround:
  ...
  szeged: {
    ...
    layout:
      "The Tisza runs down the eastern side of the city from the north-east, with the old town on its west bank. The centre is the cathedral square, the Votive Church and its square the mark of the rebuilding period; three ring roads enclose it, with late nineteenth-century blocks between them. Across the river is Újszeged, with thermal baths and parks.",
    gettingAround:
    ...
    whenAndTips:
      "May–June and September are the most comfortable; summers are hot, but the sunshine hours here are among the highest in the country and open-air events cluster in that season. The city is small and the centre can be walked in a day.",
  },
  pecs: {
    identity:
    ...
    layout:
      "The centre is Széchenyi Square, with the domed church that was once a mosque standing above it. North of the square are the cathedral and the high ground holding the early Christian necropolis, and beyond that the slope and the paths up the Mecsek; south of it the ground eases into shopping streets and the railway station. The former industrial and mining districts lie to the east.",
    gettingAround:
    ...
    whenAndTips:
      "April–June and September–October are the most comfortable, and spring arrives here earlier than in the north. Summers are hotter than elsewhere in the country. The centre has gradient north to south — wear something you can walk in.",
  },
  gyor: {
    identity:
    ...
    layout:
      "The Rába and the Mosoni-Duna meet at the northern edge of the city, and the old town occupies the spit between them; Chapter Hill is the one piece of high ground, with the cathedral on top. Below it lie the baroque quarter and a chain of small connected squares, with the shopping street running south to the railway station. The industrial estates are on the eastern and southern fringes.",
    gettingAround:
  ...
  sopron: {
    ...
    layout:
      "The old town is an oval ring with the main square at its middle and the Fire Tower at the northern entrance. Outside the ring are nineteenth-century quarters and beyond them vineyards and hills. Lake Fertő lies to the north-east, shallow water behind broad belts of reed.",
    gettingAround:
  ...
  szentendre: {
    ...
    layout:
      "The Danube is on the east, its bank a promenade lined with restaurants. The old town climbs west from the water, its centre the main square, with lanes running up to the church hill and a view over the river and the far bank. Further west are hillside houses, and a few kilometres out of town the open-air ethnographic museum.",
    gettingAround:
  ...
  veszprem: {
    ...
    identity:
      "Veszprém is a county seat in Transdanubia, western Hungary, built on a terrace at the southern foot of the Bakony hills about 11 km in a straight line from the north shore of Lake Balaton; its resident population on 1 January 2025 was about 55,000 (Hungarian Central Statistical Office). The castle quarter stands on a ridge beside the old town, with the cathedral and the archbishop's palace; in 2023 Veszprém and the Balaton region were a European Capital of Culture.",
    howItWorks:
    ...
    culture:
      "Hungarian is spoken, with English usable among younger people and in tourism. Veszprém is a university town and a bishop's see, and the churches in the castle quarter are in use, so dress modestly and keep quiet inside. The north shore of Lake Balaton is a wine region, and nearby Herend is known for its porcelain. Some restaurant bills already include a service charge, so check the bill before tipping.",
    seeAndDo:
