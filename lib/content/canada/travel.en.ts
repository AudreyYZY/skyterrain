...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  banff: {
    ...
    identity:
      "Banff is a small town in the Canadian Rockies about 126 km by road west of Calgary in Alberta, at about 1,400 m, with about 8,300 people (2021 census). It lies inside Banff National Park, established in 1885 as Canada's first national park, and in 1990 became the first municipality incorporated inside a Canadian national park. The park was created around the Cave and Basin hot springs discovered in 1883, and in 1985 it was inscribed with Jasper and its neighbours as the 'Canadian Rocky Mountain Parks' World Heritage site. Lake Louise lies about 52 km in a straight line north-west, and the Icefields Parkway runs from here to Jasper. The land is the traditional territory of the Stoney Nakoda and other nations within Treaty 7.",
  ...
  charlottetown: {
    ...
    gettingAround:
      "Charlottetown Airport (YYG), about 6 km in a straight line from the city, has scheduled flights. By road over the Confederation Bridge it is about 2 hours from Moncton and 3.5 from Halifax; a summer ferry from Nova Scotia lands at Wood Islands in the south-east. Local buses run and downtown is walkable; the island needs a car, and the Confederation Trail (about 270 km of converted railway) is good for cycling. The climate is humid continental with cold snowy winters, warm summers and sea breezes.",
    culture:
