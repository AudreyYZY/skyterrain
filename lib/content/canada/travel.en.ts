...
export const TRAVEL_EN: Record<string, TravelGuide> = {
  ...
  victoria: {
    ...
    howItWorks:
      "Victoria is the capital of British Columbia, with the legislature on the Inner Harbour and the province running health and education; the City of Victoria itself covers only about 20 km² with about 92,000 people in 2021, while Greater Victoria's thirteen municipalities hold about 400,000, Saanich, Oak Bay, Esquimalt and Langford each with a council of their own and the Capital Regional District running water and regional planning. The centre wraps three sides of the Inner Harbour, with the Empress Hotel and the legislature as reference points and the oldest Chinatown in Canada; Butchart Gardens lies in Central Saanich, the ferry terminal 32 km north at Swartz Bay, the airport at Sidney, and seaplanes fly from the harbour straight to Vancouver. Newcomers most often go wrong by assuming Victoria is on the mainland, when it is on Vancouver Island, or by taking the City of Victoria for the whole, when it holds a quarter of Greater Victoria.",
    layout:
