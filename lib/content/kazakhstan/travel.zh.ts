...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  almaty: {
    ...
    gettingAround:
      "阿拉木图国际机场（ALA）距市区约21公里；市内有地铁一号线与公交网络，前往梅德奥、大阿拉木图湖等山区景点通常需包车或参加当地旅行团；查伦峡谷、科尔赛—凯恩迪湖群需从阿拉木图出发进行1至2日行程。",
    culture:
  ...
  karaganda: {
    ...
    gettingAround:
      "萨雷阿尔卡机场（KGF）距市区约23公里；市内以公交车与出租车为主要交通方式，前往卡尔卡拉雷或别克套阿塔通常需包车，山路车程各需数小时。",
    culture:
