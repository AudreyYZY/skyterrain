...
export const TRAVEL_ZH: Record<string, TravelGuide> = {
  ...
  "kazakhstan-overview": {
    ...
    culture:
      "哈萨克斯坦是多民族的世俗国家，伊斯兰教与东正教是主要宗教，宗教氛围总体温和。哈萨克传统待客礼仪（“肯纳卡瑟”）极为隆重，受邀做客通常会被奉上丰盛食物，接受主人递上的食物是基本礼貌；进入清真寺或陵墓等宗教场所需脱鞋，女性需备头巾。与东南亚多国不同，哈萨克斯坦有给小费的习惯，餐厅通常给账单的5%至10%，中高档餐厅可能已含服务费。",
    seeAndDo:
  ...
  karaganda: {
    ...
    culture:
      "官方语言哈萨克语，俄语在卡拉干达广泛使用。餐厅账单外通常再给5%至10%小费，接受主人递上的食物是基本待客礼仪。",
    seeAndDo:
